...
{
    public class AdminDAC3 : SqlClientBase
    {
        protected bool result = false;
        public AdminDAC3(BasePage basePage) : base(basePage)
        {
        ...
        public static string GetConfigValue(string paramName)
        {
            ...
            {
                return string.Empty;
                string detailedError = ErrorLogger.FormatError(error, typeof(AdminDAC3).FullName);
                twbobibobi.Data.BasePage basePage = new twbobibobi.Data.BasePage();
                basePage.SaveErrorLog("AdminDAC.InsertAdmin：\r\n" + detailedError);
            }
        }
                ...
                case "1":
                    ...
                    switch (AdminID)
                    {
                        ...
                        case "35":
                            ...
                            sql = "Select * from Temple_" + Year + "..APPCharge_st_Lights Where Status = 1 and UniqueID = @UniqueID";
                            break;
                        case "38":
                            //池上北極玄天宮
                            view = "Temple_" + Year + "..APPCharge_bj_Lights";
                            sql = "Select * from Temple_" + Year + "..APPCharge_bj_Lights Where Status = 1 and UniqueID = @UniqueID";
                            break;
                        case "39":
                            //慈惠石壁部堂
                            view = "Temple_" + Year + "..APPCharge_sbbt_Lights";
                            sql = "Select * from Temple_" + Year + "..APPCharge_sbbt_Lights Where Status = 1 and UniqueID = @UniqueID";
                            break;
                        case "40":
                            //真武山受玄宮
                            view = "Temple_" + Year + "..APPCharge_bpy_Lights";
                            sql = "Select * from Temple_" + Year + "..APPCharge_bpy_Lights Where Status = 1 and UniqueID = @UniqueID";
                            break;
                        case "41":
                            //壽山巖觀音寺
                            view = "Temple_" + Year + "..APPCharge_ssy_Lights";
                            sql = "Select * from Temple_" + Year + "..APPCharge_ssy_Lights Where Status = 1 and UniqueID = @UniqueID";
                            break;
                    }
                    break;
                case "2":
                    ...
                    switch (AdminID)
                    {
                        ...
                        case "29":
                            ...
                            sql = "Select * from Temple_" + Year + "..APPCharge_jb_Purdue Where Status = 1 and UniqueID = @UniqueID";
                            break;
                        case "30":
                            //鎮瀾買足
                        ...
                        case "31":
                            ...
                            sql = "Select * from Temple_" + Year + "..APPCharge_wjsan_Purdue Where Status = 1 and UniqueID = @UniqueID";
                            break;
                        case "32":
                            //桃園龍德宮
                            view = "Temple_" + Year + "..APPCharge_ld_Purdue";
                            sql = "Select * from Temple_" + Year + "..APPCharge_ld_Purdue Where Status = 1 and UniqueID = @UniqueID";
                            break;
                        case "34":
                            //基隆悟玄宮
                            view = "Temple_" + Year + "..APPCharge_wh_Purdue";
                            sql = "Select * from Temple_" + Year + "..APPCharge_wh_Purdue Where Status = 1 and UniqueID = @UniqueID";
                            break;
                    }
                    break;
                case "3":
                ...
                case "9":
                    ...
                    switch (AdminID)
                    {
                        case "14":
                            ...
                            sql = "Select * from Temple_" + Year + "..APPCharge_ty_EmperorGuansheng Where Status = 1 and UniqueID = @UniqueID";
                            break;
                    }
                    break;
                case "10":
                ...
                case "21":
                    ...
                    switch (AdminID)
                    {
                        case "31":
                            ...
                            sql = "Select * from Temple_" + Year + "..APPCharge_wjsan_Huaguo Where Status = 1 and UniqueID = @UniqueID";
                            break;
                    }
                    break;
                case "22":
                ...
                case "23":
                    ...
                    switch (AdminID)
                    {
                        case "35":
                            ...
                            sql = "Select * from Temple_" + Year + "..APPCharge_st_Blessing Where Status = 1 and UniqueID = @UniqueID";
                            break;
                    }
                    break;
                case "24":
                        ...
                        if (res > 0)
                        {
                            if (Updatestatus2applicantinfo(int.Parse(dtDataList.Rows[0]["ApplicantID"].ToString()), Status, AdminID, kind, type, Year))
                            {
                                switch (kind)
                                {
                                    ...
                                    case "9":
                                        //關帝聖君聖誕
                                        if (DeleteEmperorGuanshengNum(int.Parse(dtDataList.Rows[0]["ApplicantID"].ToString()), AdminID, 4, Year))
                                        {
                                            bResult = true;
                                        }
                                        break;
                                    ...
                                    case "21":
                                        //供花供果
                                        if (DeleteHuaguoinfo(int.Parse(dtDataList.Rows[0]["ApplicantID"].ToString()), AdminID, Year))
                                        {
                                            bResult = true;
                                        }
                                        break;
                                    case "22":
                                        //孝親祈福燈
                                        if (DeleteLightsinfo(int.Parse(dtDataList.Rows[0]["ApplicantID"].ToString()), AdminID, 2, Year))
                                        {
                                            bResult = true;
                                        }
                                        break;
                                    case "23":
                                        //祈安植福
                                        if (DeleteBlessinginfo(int.Parse(dtDataList.Rows[0]["ApplicantID"].ToString()), AdminID, Year))
                                        {
                                            bResult = true;
                                        }
                                        break;
                                    case "24":
                                        //祈安禮斗
                                        if (DeleteSuppliesNum(int.Parse(dtDataList.Rows[0]["ApplicantID"].ToString()), AdminID, 24, Year))
                                        {
                                            bResult = true;
                                        }
                                        break;
                                    case "25":
                                        //千手觀音千燈迎佛法會
                                        if (DeleteQnLightinfo(int.Parse(dtDataList.Rows[0]["ApplicantID"].ToString()), AdminID, Year))
                                        {
                                            bResult = true;
                                        }
                                        break;
                ...
                case "1":
                    ...
                    switch (AdminID)
                    {
                        ...
                        case "35":
                            ...
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_st_Lights Where Status = 2 and ApplicantID = @ApplicantID";
                            break;
                        case "38":
                            //池上北極玄天宮
                            view = "Temple_" + Year + "..ApplicantInfo_bj_Lights";
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_bj_Lights Where Status = 2 and ApplicantID = @ApplicantID";
                            break;
                        case "39":
                            //慈惠石壁部堂
                            view = "Temple_" + Year + "..ApplicantInfo_sbbt_Lights";
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_sbbt_Lights Where Status = 2 and ApplicantID = @ApplicantID";
                            break;
                        case "40":
                            //真武山受玄宮
                            view = "Temple_" + Year + "..ApplicantInfo_bpy_Lights";
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_bpy_Lights Where Status = 2 and ApplicantID = @ApplicantID";
                            break;
                        case "41":
                            //壽山巖觀音寺
                            view = "Temple_" + Year + "..ApplicantInfo_ssy_Lights";
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_ssy_Lights Where Status = 2 and ApplicantID = @ApplicantID";
                            break;
                    }
                    break;
                case "2":
                    ...
                    switch (AdminID)
                    {
                        ...
                        case "29":
                            ...
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_jb_Purdue Where Status = 2 and ApplicantID = @ApplicantID";
                            break;
                        case "30":
                            //鎮瀾買足
                        ...
                        case "31":
                            ...
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_wjsan_Purdue Where Status = 2 and ApplicantID = @ApplicantID";
                            break;
                        case "32":
                            //桃園龍德宮
                            view = "Temple_" + Year + "..ApplicantInfo_ld_Purdue";
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_ld_Purdue Where Status = 2 and ApplicantID = @ApplicantID";
                            break;
                        case "34":
                            //基隆悟玄宮
                            view = "Temple_" + Year + "..ApplicantInfo_wh_Purdue";
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_wh_Purdue Where Status = 2 and ApplicantID = @ApplicantID";
                            break;
                    }
                    break;
                case "3":
                ...
                case "9":
                    ...
                    switch (AdminID)
                    {
                        case "14":
                            ...
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_ty_EmperorGuansheng Where Status = 2 and ApplicantID = @ApplicantID";
                            break;
                    }
                    break;
                case "10":
                ...
                case "21":
                    ...
                    switch (AdminID)
                    {
                        case "31":
                            ...
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_wjsan_Huaguo Where Status = 2 and ApplicantID = @ApplicantID";
                            break;
                    }
                    break;
                case "22":
                ...
                case "23":
                    ...
                    switch (AdminID)
                    {
                        case "35":
                            ...
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_st_Blessing Where Status = 2 and ApplicantID = @ApplicantID";
                            break;
                    }
                    break;
                case "24":
        ...
        public bool DeleteLightsinfo(int ApplicantID, string AdminID, int type, string Year)
        {
            ...
            switch (AdminID)
            {
                ...
                case "35":
                    //松柏嶺受天宮
                    view = "Temple_" + Year + "..Lights_st_info";
                    sql = "Select * from Temple_" + Year + "..Lights_st_info Where ApplicantID = @ApplicantID and Status = 0";
                    break;
                case "38":
                    //池上北極玄天宮
                    view = "Temple_" + Year + "..Lights_bj_info";
                    sql = "Select * from Temple_" + Year + "..Lights_bj_info Where ApplicantID = @ApplicantID and Status = 0";
                    break;
                case "39":
                    //慈惠石壁部堂
                    view = "Temple_" + Year + "..Lights_sbbt_info";
                    sql = "Select * from Temple_" + Year + "..Lights_sbbt_info Where ApplicantID = @ApplicantID and Status = 0";
                    break;
                case "40":
                    //真武山受玄宮
                    view = "Temple_" + Year + "..Lights_bpy_info";
                    sql = "Select * from Temple_" + Year + "..Lights_bpy_info Where ApplicantID = @ApplicantID and Status = 0";
                    break;
                case "41":
                    //壽山巖觀音寺
                    view = "Temple_" + Year + "..Lights_ssy_info";
                    sql = "Select * from Temple_" + Year + "..Lights_ssy_info Where ApplicantID = @ApplicantID and Status = 0";
                    break;
            }
        ...
        public bool DeletePurdueinfo(int ApplicantID, string AdminID, string Year)
        {
            ...
            switch (AdminID)
            {
                ...
                case "29":
                    //進寶財神廟
                    view = "Temple_" + Year + "..Purdue_jb_info";
                    sql = "Select * from Temple_" + Year + "..Purdue_jb_info Where ApplicantID = @ApplicantID and Status = 0";
                    break;
                case "30":
                    //鎮瀾買足
                ...
                case "31":
                    //台灣道教總廟無極三清總道院
                    view = "Temple_" + Year + "..Purdue_wjsan_info";
                    sql = "Select * from Temple_" + Year + "..Purdue_wjsan_info Where ApplicantID = @ApplicantID and Status = 0";
                    break;
                case "32":
                    //桃園龍德宮
                    view = "Temple_" + Year + "..Purdue_ld_info";
                    sql = "Select * from Temple_" + Year + "..Purdue_ld_info Where ApplicantID = @ApplicantID and Status = 0";
                    break;
                case "34":
                    //基隆悟玄宮
                    view = "Temple_" + Year + "..Purdue_wh_info";
                    sql = "Select * from Temple_" + Year + "..Purdue_wh_info Where ApplicantID = @ApplicantID and Status = 0";
                    break;
            }
        ...
        public bool DeleteSuppliesNum(int ApplicantID, string AdminID, int Suppliestype, string Year)
        {
            ...
            switch (AdminID)
            {
                ...
                case "34":
                    ...
                    sql = $"Select * from {view} Where Status = 0 and ApplicantID = @ApplicantID";
                    break;
            }
        ...
        /// <param name="AdminID">AdminID=廟宇編號 3-大甲鎮瀾宮 4-新港奉天宮 5-文創商品(新港奉天宮) 6-北港武德宮</param>
        /// </summary>
        public bool DeleteEmperorGuanshengNum(int ApplicantID, string AdminID, int EmperorGuanshengtype, string Year)
        {
            bool result = false;
            string sql = string.Empty;
            string view = string.Empty;
            ...
            switch (AdminID)
            {
                case "14":
                    ...
                    sql = "Select * from Temple_" + Year + "..EmperorGuansheng_ty_info Where Status = 0 and ApplicantID = @ApplicantID";
                    break;
            }
            ...
            if (sql != "")
            {
                ...
                if (dtUpdateStatus.Rows.Count > 0)
                {
                    for (int i = 0; i < dtUpdateStatus.Rows.Count; i++)
                    {
                        int EmperorGuanshengID = int.Parse(dtUpdateStatus.Rows[i]["EmperorGuanshengID"].ToString());
                        //dtUpdateStatus.Rows[i]["Num2String"] = "";
                        //dtUpdateStatus.Rows[i]["Num"] = 0;
                        //Adapter.Update(dtUpdateStatus);
                        if (view != "")
                        {
                            int res = ExecuteSql("Update " + view + " Set Num2String = '', Num = 0 Where EmperorGuanshengID=" + EmperorGuanshengID);
        ...
        /// <param name="AdminID">AdminID=廟宇編號 3-大甲鎮瀾宮 4-新港奉天宮 5-文創商品(新港奉天宮) 6-北港武德宮</param>
        /// </summary>
        public bool DeleteHuaguoinfo(int ApplicantID, string AdminID, string Year)
        {
            bool result = false;
            string sql = string.Empty;
            string view = string.Empty;
            ...
            switch (AdminID)
            {
                case "31":
                    //台灣道教總廟無極三清總道院
                    view = "Temple_" + Year + "..Huaguo_wjsan_info";
                    sql = "Select * from Temple_" + Year + "..Huaguo_wjsan_info Where ApplicantID = @ApplicantID";
                    break;
            }
            ...
            if (sql != "")
            {
                ...
                if (dtUpdateStatus.Rows.Count > 0)
                {
                    for (int i = 0; i < dtUpdateStatus.Rows.Count; i++)
                    {
                        int HuaguoID = int.Parse(dtUpdateStatus.Rows[i]["HuaguoID"].ToString());
                        //dtUpdateStatus.Rows[i]["Num2String"] = "";
                        //dtUpdateStatus.Rows[i]["Num"] = 0;
                        //Adapter.Update(dtUpdateStatus);
                        ...
                        if (view != "")
                        {
                            int res = ExecuteSql("Update " + view + " Set Num2String = '', Num = 0 Where HuaguoID=" + HuaguoID);
        ...
        /// <param name="Year"></param>
        /// </summary>
        public bool DeleteQnLightinfo(int ApplicantID, string AdminID, string Year)
        {
            bool result = false;
            string sql = string.Empty;
            string view = string.Empty;
            ...
            switch (AdminID)
            {
                case "14":
                    // 桃園威天宮
                    view = "Temple_" + Year + "..QnLight_ty_info";
                    sql = $"Select * from {view} Where ApplicantID = @ApplicantID";
                    break;
            }
            ...
            if (sql != "")
            {
                ...
                if (dtUpdateStatus.Rows.Count > 0)
                {
                    for (int i = 0; i < dtUpdateStatus.Rows.Count; i++)
                    {
                        int QnLightID = int.Parse(dtUpdateStatus.Rows[i]["QnLightID"].ToString());

                        if (view != "")
                        {
                            int res = ExecuteSql("Update " + view + " Set Num2String = '', Num = 0 Where QnLightID=" + QnLightID);
        ...
        /// <param name="Year"></param>
        /// </summary>
        public bool DeleteBlessinginfo(int ApplicantID, string AdminID, string Year)
        {
            bool result = false;
            string sql = string.Empty;
            string view = string.Empty;
            ...
            switch (AdminID)
            {
                case "35":
                    //松柏嶺受天宮
                    view = "Temple_" + Year + "..Blessing_st_info";
                    sql = "Select * from Temple_" + Year + "..Blessing_st_info Where ApplicantID = @ApplicantID";
                    break;
            }
            ...
            if (sql != "")
            {
                ...
                if (dtUpdateStatus.Rows.Count > 0)
                {
                    for (int i = 0; i < dtUpdateStatus.Rows.Count; i++)
                    {
                        int BlessingID = int.Parse(dtUpdateStatus.Rows[i]["BlessingID"].ToString());
                        //dtUpdateStatus.Rows[i]["Num2String"] = "";
                        //dtUpdateStatus.Rows[i]["Num"] = 0;
                        //Adapter.Update(dtUpdateStatus);
                        ...
                        if (view != "")
                        {
                            int res = ExecuteSql("Update " + view + " Set Num2String = '', Num = 0 Where BlessingID=" + BlessingID);
