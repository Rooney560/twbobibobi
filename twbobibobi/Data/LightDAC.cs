...
namespace Temple.data
{
    public class LightDAC : SqlClientBase
    {
        ...
        //補財庫項目 1-下元補庫 2-呈疏補庫(天官武財神聖誕補財庫) 3-企業補財庫 4-天赦日補運 5-天赦日祭改 6-代燒金紙 7-招財補運 8-招財補運九九重陽升級版 9-補財庫 10-財神賜福-消災補庫法會 11-地母廟-赦罪解業
        ...
        /// <param name="Mobile">Mobile=手機號碼</param>
        /// <param name="Sex">Sex=性別</param>
        /// <param name="SuppliesType">SuppliesType=補庫項目 1-下元補庫 2-呈疏補庫(天官武財神聖誕補財庫) 3-企業補財庫 4-天赦日補運 5-天赦日祭改 6-天貺納福添運法會 7-招財補運 8-招財補運九九重陽升級版
        ...
        public int addSupplies_ma(int applicantID, string Name, string Mobile, string Sex, string SuppliesType, string SuppliesString, string oversea, string Birth, string LeapMonth, 
            string BirthTime, string BirthMonth, string Age, string Zodiac, string sBirth, string Email, string HomeNum, int Count, string Remark, string Addr, string County, 
            string Dist, string ZipCode, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);
            ...
            string sql = "Insert into Temple_" + Year + "..Supplies_ma_info(ApplicantID, AdminID, Name, Mobile, Cost, Sex, SuppliesType, SuppliesString, oversea, Birth, LeapMonth, " +
                "BirthTime, BirthMonth, Age, Zodiac, sBirth, Email, HomeNum, Count, Remark, Address, Addr, County, dist, ZipCode, CreateDate) " +
                ...
                "@sBirth, @Email, @HomeNum, @Count, @Remark, @Address, @Addr, @County, @dist, @ZipCode, @CreateDate)";
        ...
        /// <param name="ZipCode">ZipCode=郵遞區號</param>
        /// </summary>
        public int addSupplies_Fw(int applicantID, string Name, string Mobile, string Sex, string SuppliesType, string SuppliesString, string oversea, string Birth, string LeapMonth,
            string BirthTime, string BirthMonth, string Age, string Zodiac, string sBirth, string Email, string HomeNum, int Count, string Remark, string Addr, string County,
            string Dist, string ZipCode, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            ...
            string sql = "Insert into Temple_" + Year + "..Supplies_Fw_info(ApplicantID, AdminID, Name, Mobile, Cost, Sex, SuppliesType, SuppliesString, oversea, Birth, LeapMonth, " +
                "BirthTime, BirthMonth, Age, Zodiac, sBirth, Email, HomeNum, Count, Remark, Address, Addr, County, dist, ZipCode, CreateDate) " +
                "values(@ApplicantID, @AdminID, @Name, @Mobile, @Cost, @Sex, @SuppliesType, @SuppliesString, @oversea, @Birth, @LeapMonth, @BirthTime, @BirthMonth, @Age, @Zodiac, " +
                "@sBirth, @Email, @HomeNum, @Count, @Remark, @Address, @Addr, @County, @dist, @ZipCode, @CreateDate)";

            int Cost = 0;
            Cost = GetSuppliesCost(SuppliesType, 15);
            ...
            Adapter.AddParameterToSelectCommand("@Count", Count);
            Adapter.AddParameterToSelectCommand("@Remark", Remark);
            Adapter.AddParameterToSelectCommand("@Address", County + (Dist.IndexOf("*") >=0 ? "" : Dist) + Addr);
            Adapter.AddParameterToSelectCommand("@Addr", Addr);
            Adapter.AddParameterToSelectCommand("@County", County);
            Adapter.AddParameterToSelectCommand("@dist", Dist);
            Adapter.AddParameterToSelectCommand("@ZipCode", ZipCode);
        ...
        /// <param name="Mobile">Mobile=手機號碼</param>
        /// <param name="Sex">Sex=性別</param>
        /// <param name="SuppliesType">SuppliesType=補庫項目 1-下元補庫 2-呈疏補庫(天官武財神聖誕補財庫) 3-企業補財庫 4-天赦日補運 5-天赦日祭改 6-天貺納福添運法會 7-招財補運 8-招財補運九九重陽升級版</param>
        /// <param name="oversea">oversea=1-國內 2-國外</param>
        /// <param name="Birth">Birth=農曆生日</param>
        /// <param name="BirthTime">BirthTime=農曆時辰</param>
        /// <param name="LeapMonth">LeapMonth=閏月 Y-是 N-否</param>
        ...
        /// <param name="Mobile">Mobile=手機號碼</param>
        /// <param name="Sex">Sex=性別</param>
        /// <param name="SuppliesType">SuppliesType=補庫項目 1-下元補庫 2-呈疏補庫(天官武財神聖誕補財庫) 3-企業補財庫 4-天赦日補運 5-天赦日祭改 6-天貺納福添運法會 7-招財補運 8-招財補運升級版 20-天公生招財補運</param>
        /// <param name="oversea">oversea=1-國內 2-國外</param>
        /// <param name="Birth">Birth=農曆生日</param>
        /// <param name="LeapMonth">LeapMonth=閏月 Y-是 N-否</param>
        /// <param name="BirthTime">BirthTime=農曆時辰</param>
        ...
        /// <param name="ZipCode">ZipCode=郵遞區號</param>
        /// </summary>
        public int addSupplies2_sx(int applicantID, string Name, string Mobile, string Sex, string SuppliesType, string SuppliesString, string oversea, string Birth, string LeapMonth,
            string BirthTime, string BirthMonth, string Age, string Zodiac, string sBirth, string Email, string HomeNum, int Count, string Addr, string County, string Dist,
            string ZipCode, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            ...
            string sql = "Insert into Temple_" + Year + "..Supplies2_sx_info(ApplicantID, AdminID, Name, Mobile, Cost, Sex, SuppliesType, SuppliesString, oversea, Birth, " +
                "LeapMonth, BirthTime, BirthMonth, Age, Zodiac, sBirth, Email, HomeNum, Count, Address, Addr, County, dist, ZipCode, CreateDate) " +
                "values(@ApplicantID, @AdminID, @Name, @Mobile, @Cost, @Sex, @SuppliesType, @SuppliesString, @oversea, @Birth, @LeapMonth, @BirthTime, @BirthMonth, @Age, " +
                "@Zodiac, @sBirth, @Email, @HomeNum, @Count, @Address, @Addr, @County, @dist, @ZipCode, @CreateDate)";
        ...
        /// <param name="Remark">Remark=備註</param>
        /// </summary>
        public int addsupplies_wu2(int applicantID, string Name, string Mobile, string SuppliesType, string SuppliesString, string Sex, string oversea, string Birth, 
            string LeapMonth, string BirthTime, string BirthMonth, string Age, string Zodiac, string sBirth, string HomeNum, string Email, string Addr, string County,
            string Dist, string ZipCode, string Remark, string Count, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);

            string sql = "Insert into Temple_" + Year + "..Supplies_wu_info2(ApplicantID, AdminID, Name, Mobile, Cost, SuppliesType, SuppliesString, Sex, oversea, Birth, LeapMonth, " +
                "BirthTime, BirthMonth, Age, Zodiac, sBirth, HomeNum, Email, Address, Addr, County, dist, ZipCode, Remark, Count, CreateDate) " +
                "values(@ApplicantID, @AdminID, @Name, @Mobile, @Cost, @SuppliesType, @SuppliesString, @Sex, @oversea, @Birth, @LeapMonth, @BirthTime, @BirthMonth, @Age, @Zodiac, " +
                "@sBirth, @HomeNum, @Email, @Address, @Addr, @County, @dist, @ZipCode, @Remark, @Count, @CreateDate)";
        ...
        /// <param name="Remark">Remark=備註</param>
        /// </summary>
        public int addsupplies_wu3(int applicantID, string Name, string Mobile, string SuppliesType, string SuppliesString, string Sex, string oversea, string Birth, 
            string LeapMonth, string BirthTime, string BirthMonth, string Age, string Zodiac, string sBirth, string HomeNum, string Email, string Addr, 
            string County, string Dist, string ZipCode, string Remark, string Count, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);

            string sql = "Insert into Temple_" + Year + "..Supplies_wu_info3(ApplicantID, AdminID, Name, Mobile, Cost, SuppliesType, SuppliesString, Sex, oversea, Birth, " +
                "LeapMonth, BirthTime, BirthMonth, Age, Zodiac, sBirth, HomeNum, Email, Address, Addr, County, dist, ZipCode, Remark, Count, CreateDate) " +
                "values(@ApplicantID, @AdminID, @Name, @Mobile, @Cost, @SuppliesType, @SuppliesString, @Sex, @oversea, @Birth, @LeapMonth, @BirthTime, @BirthMonth, @Age, " +
                "@Zodiac, @sBirth, @HomeNum, @Email, @Address, @Addr, @County, @dist, @ZipCode, @Remark, @Count, @CreateDate)";
        ...
        /// <param name="ZipCode">ZipCode=郵遞區號</param>
        /// </summary>
        public int addAnDou_Fw(int applicantID, string Name, string Mobile, string Sex, string AnDouType, string AnDouString, string oversea, string Birth, string LeapMonth,
            string BirthTime, string BirthMonth, string Age, string Zodiac, string sBirth, string Email, int Count, string Addr, string County, string Dist, string ZipCode,
            string PetName, string PetType, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            ...
            string sql = "Insert into Temple_" + Year + "..AnDou_Fw_info(ApplicantID, AdminID, Name, Mobile, Cost, Sex, AnDouType, AnDouString, oversea, Birth, LeapMonth, " +
                "BirthTime, BirthMonth, Age, Zodiac, sBirth, Email, Count, Address, Addr, County, dist, ZipCode, PetName, PetType, CreateDate) " +
                "values(@ApplicantID, @AdminID, @Name, @Mobile, @Cost, @Sex, @AnDouType, @AnDouString, @oversea, @Birth, @LeapMonth, @BirthTime, @BirthMonth, @Age, @Zodiac, " +
                "@sBirth, @Email, @Count, @Address, @Addr, @County, @dist, @ZipCode, @PetName, @PetType, @CreateDate)";

            int Cost = 0;
            Cost = GetLightsCost(AnDouType, 15);
        ...
        /// <param name="ZipCode">ZipCode=郵遞區號</param>
        /// </summary>
        public int addLights_Hs(int applicantID, string Name, string Mobile, string Sex, string LightsType, string LightsString, string oversea, string Birth, string LeapMonth,
            string BirthTime, string BirthMonth, string Age, string Zodiac, string sBirth, string Email, int Count, string Addr, string County, string Dist, string ZipCode,
            string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            ...
            string sql = "Insert into Temple_" + Year + "..Lights_Hs_info(ApplicantID, AdminID, Name, Mobile, Cost, Sex, LightsType, LightsString, oversea, Birth, LeapMonth, " +
                "BirthTime, BirthMonth, Age, Zodiac, sBirth, Email, Count, Address, Addr, County, dist, ZipCode, CreateDate) " +
                "values(@ApplicantID, @AdminID, @Name, @Mobile, @Cost, @Sex, @LightsType, @LightsString, @oversea, @Birth, @LeapMonth, @BirthTime, @BirthMonth, @Age, @Zodiac, " +
                "@sBirth, @Email, @Count, @Address, @Addr, @County, @dist, @ZipCode, @CreateDate)";

            int Cost = 0;
            Cost = GetLightsCost(LightsType, 17);

            DatabaseAdapter Adapter = new DatabaseAdapter(sql, this.DBSource);
            DataTable dtdata = new DataTable();
            Adapter.AddParameterToSelectCommand("@ApplicantID", applicantID);
            Adapter.AddParameterToSelectCommand("@AdminID", 17);
            Adapter.AddParameterToSelectCommand("@Name", Name);
            Adapter.AddParameterToSelectCommand("@Mobile", Mobile);
            Adapter.AddParameterToSelectCommand("@Cost", Cost);
            Adapter.AddParameterToSelectCommand("@Sex", Sex);
        ...
        /// <param name="ZipCode">ZipCode=郵遞區號</param>
        /// </summary>
        public int addAnDou_wjsan(int applicantID, string Name, string Mobile, string Sex, string AnDouType, string AnDouString, string oversea, string Birth,
            string LeapMonth, string BirthTime, string BirthMonth, string Age, string Zodiac, string sBirth, string Email, int Count, string Addr, string County, string Dist,
            string ZipCode, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            ...
            string sql = "Insert into Temple_" + Year + "..AnDou_wjsan_info(ApplicantID, AdminID, Name, Mobile, Cost, Sex, AnDouType, AnDouString, oversea, Birth, LeapMonth, " +
                "BirthTime, BirthMonth, Age, Zodiac, sBirth, Email, Count, Address, Addr, County, dist, ZipCode, CreateDate) " +
                "values(@ApplicantID, @AdminID, @Name, @Mobile, @Cost, @Sex, @AnDouType, @AnDouString, @oversea, @Birth, @LeapMonth, @BirthTime, @BirthMonth, @Age, @Zodiac, " +
                "@sBirth, @Email, @Count, @Address, @Addr, @County, @dist, @ZipCode, @CreateDate)";

            int Cost = 0;
            Cost = GetLightsCost(AnDouType, 31);
        ...
        /// <param name="Phone"></param>
        /// <returns></returns>
        public int addapplicantinfo_andou_Fw(string Name, string Mobile, string Cost, string County, string dist, string Addr, string ZipCode, string Sendback, string ReceiptName, string ReceiptMobile, int Status, string adminID, string postURL, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);

            string sql = "Insert into Temple_" + Year + "..ApplicantInfo_Fw_AnDou(Name, Mobile, Cost, County, dist, Addr, Address, Sendback, ReceiptName, ReceiptMobile, PostURL, AdminID, Status, CreateDate, CreateDateString) " +
                "       values(@Name, @Mobile, @Cost, @County, @dist, @Addr, @Address, @Sendback, @ReceiptName, @ReceiptMobile, @PostURL, @AdminID, @Status, @CreateDate, @CreateDateString)";
        ...
        /// <summary>
        /// 建立台灣道教總廟無極三清總道院安斗購買人資料
        /// </summary>
        /// <param name="Name"></param>
        /// <param name="Phone"></param>
        /// <returns></returns>
        public int addapplicantinfo_andou_wjsan(string Name, string Mobile, string Cost, string County, string dist, string Addr, string ZipCode, string Sendback,
            string ReceiptName, string ReceiptMobile, int Status, string adminID, string postURL, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);

            string sql = "Insert into Temple_" + Year + "..ApplicantInfo_wjsan_AnDou(Name, Mobile, Cost, County, dist, Addr, Address, Sendback, ReceiptName, ReceiptMobile, PostURL, " +
                "AdminID, Status, CreateDate, CreateDateString) " +
                "       values(@Name, @Mobile, @Cost, @County, @dist, @Addr, @Address, @Sendback, @ReceiptName, @ReceiptMobile, @PostURL, @AdminID, @Status, @CreateDate, " +
                "@CreateDateString)";
        ...
        /// <summary>
        /// 建立補財庫(呈疏補庫(天官武財神聖誕補財庫))購買人資料
        /// </summary>
        /// <param name="Name"></param>
        /// <param name="Phone"></param>
        /// <returns></returns>
        public int addapplicantinfo_Supplies_wu2(string Name, string Mobile, string Cost, string Email, string County, string dist, string Addr, string ZipCode, string Sendback, string ReceiptName, string ReceiptMobile, int Status, string adminID, string postURL, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);

            string sql = "Insert into Temple_" + Year + "..ApplicantInfo_wu_Supplies2(Name, Mobile, Cost, Email, County, dist, Addr, Address, Sendback, ReceiptName, ReceiptMobile, PostURL, AdminID, Status, CreateDate, CreateDateString) " +
                "       values(@Name, @Mobile, @Cost, @Email, @County, @dist, @Addr, @Address, @Sendback, @ReceiptName, @ReceiptMobile, @PostURL, @AdminID, @Status, @CreateDate, @CreateDateString)";
        ...
        /// <param name="Phone"></param>
        /// <returns></returns>
        public int addapplicantinfo_Supplies_wu3(string Name, string Mobile, string Cost, string Email, string County, string dist, string Addr, string ZipCode, string Sendback, string ReceiptName, string ReceiptMobile, int Status, string adminID, string postURL, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);

            string sql = "Insert into Temple_" + Year + "..ApplicantInfo_wu_Supplies3(Name, Mobile, Cost, Email, County, dist, Addr, Address, Sendback, ReceiptName, ReceiptMobile, PostURL, AdminID, NewUser, AddDate, AddDateString, Status, CreateDate, CreateDateString) " +
                "       values(@Name, @Mobile, @Cost, @Email, @County, @dist, @Addr, @Address, @Sendback, @ReceiptName, @ReceiptMobile, @PostURL, @AdminID, @NewUser, @AddDate, @AddDateString, @Status, @CreateDate, @CreateDateString)";
        ...
        public int addapplicantinfo_Supplies_Lk(string Name, string Mobile, string Cost, string County, string dist, string Addr, string ZipCode, string Sendback, string ReceiptName, string ReceiptMobile, int Status, string adminID, string postURL, string Year)
        {
            ...
            string sql = "Insert into Temple_" + Year + "..ApplicantInfo_Lk_Supplies(Name, Mobile, Cost, County, dist, Addr, ZipCode, Address, Sendback, ReceiptName, " +
                "ReceiptMobile, PostURL, AdminID, Status, CreateDate, CreateDateString) " +
                "       values(@Name, @Mobile, @Cost, @County, @dist, @Addr, @ZipCode, @Address, @Sendback, @ReceiptName, @ReceiptMobile, @PostURL, @AdminID, @Status, " +
        ...
        /// <param name="Phone"></param>
        /// <returns></returns>
        public int addapplicantinfo_Supplies2_sx(string Name, string Mobile, string Email, string Cost, string County, string dist, string Addr, string ZipCode, string Sendback, 
            string ReceiptName, string ReceiptMobile, int Status, string adminID, string postURL, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);

            string sql = "Insert into Temple_" + Year + "..ApplicantInfo_sx_Supplies2(Name, Mobile, Email, Cost, County, dist, Addr, Address, Sendback, ReceiptName, " +
                "ReceiptMobile, PostURL, AdminID, Status, CreateDate, CreateDateString) " +
                "       values(@Name, @Mobile, @Email, @Cost, @County, @dist, @Addr, @Address, @Sendback, @ReceiptName, @ReceiptMobile, @PostURL, @AdminID, @Status, " +
                "@CreateDate, @CreateDateString)";
        ...
        /// <summary>
        /// 建立玉敕大樹朝天宮天赦日招財補運購買人資料
        /// </summary>
        /// <param name="Name"></param>
        /// <param name="Phone"></param>
        /// <returns></returns>
        public int addapplicantinfo_Supplies_ma(string Name, string Mobile, string Cost, string County, string dist, string Addr, string ZipCode, string Sendback, 
            string ReceiptName, string ReceiptMobile, int Status, string adminID, string postURL, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);
        ...
        /// <param name="Phone"></param>
        /// <returns></returns>
        public int addapplicantinfo_Supplies_Fw(string Name, string Mobile, string Cost, string County, string dist, string Addr, string ZipCode, string Sendback, 
            string ReceiptName, string ReceiptMobile, int Status, string adminID, string postURL, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);

            string sql = "Insert into Temple_" + Year + "..ApplicantInfo_Fw_Supplies(Name, Mobile, Cost, County, dist, Addr, Address, ZipCode, Sendback, ReceiptName, ReceiptMobile, " +
                "PostURL, AdminID, Status, CreateDate, CreateDateString) " +
                "       values(@Name, @Mobile, @Cost, @County, @dist, @Addr, @Address, @ZipCode, @Sendback, @ReceiptName, @ReceiptMobile, @PostURL, @AdminID, @Status, @CreateDate, " +
                "@CreateDateString)";
        ...
        /// <param name="adminID">adminID=廟宇編號 3-大甲鎮瀾宮 4-新港奉天宮 6-北港武德宮</param>
        /// </summary>
        public DataTable Getapplicantinfo_LightsInfo(string name, string phone, int type, int adminID, string Year)
        {
            string sql = string.Empty;
            DataTable dtGetData = new DataTable();
            ...
            switch (adminID)
            {
                ...
                case 14:
                    if (type == 2)
                    {
                        sql = "Select * from Temple_" + Year + "..view_Lights_ty_mom_InfowithAPPCharge Where AppStatus = 2 and Status = 0 and AdminID = @AdminID and (AppName = @Name and AppMobile = @Mobile)";
                    }
                    else
                    {
                        sql = "Select * from Temple_" + Year + "..view_Lights_ty_InfowithAPPCharge Where AppStatus = 2 and Status = 0 and AdminID = @AdminID and (AppName = @Name and AppMobile = @Mobile)";
                ...
                case 16:
                    ...
                    break;
                case 17:
                    sql = "Select * from Temple_" + Year + "..view_Lights_Hs_InfowithAPPCharge Where AppStatus = 2 and Status = 0 and AdminID = @AdminID and (AppName = @Name and AppMobile = @Mobile)";
                    break;
                case 21:
                    sql = "Select * from Temple_" + Year + "..view_Lights_Lk_InfowithAPPCharge Where AppStatus = 2 and Status = 0 and AdminID = @AdminID and (AppName = @Name and AppMobile = @Mobile)";
                    break;
        ...
        /// <param name="phone">phone=購買人手機</param>
        /// <param name="adminID">adminID=廟宇編號 3-大甲鎮瀾宮 4-新港奉天宮 6-北港武德宮</param>
        /// <param name="kind">kind=補財庫項目 1-下元補庫-北港武德宮 2-呈疏補庫(天官武財神聖誕補財庫)-北港武德宮 3-企業補財庫-北港武德宮 4-天赦日補運-桃園威天宮 5-天赦日祭改-進寶財神廟 
            ...
            switch (kind)
            {
                ...
                case 4:
                    ...
                    switch (adminID)
                    {
                        ...
                        case 23:
                            //桃園威天宮
                            sql = "Select * from Temple_" + Year + "..view_Supplies_ma_InfowithAPPCharge Where Num > 0 and AppStatus = 2 and Status = 0 and AdminID = @AdminID and (AppName = @Name and AppMobile = @Mobile)";
                            break;
                    }
                    break;
                case 5:
                ...
                case 9:
                    ...
                    {
                        case 15:
                            sql = "Select * from Temple_" + Year + "..view_Supplies_Fw_InfowithAPPCharge Where Num > 0 and AppStatus = 2 and Status = 0 and AdminID = @AdminID and " +
        ...
        /// <param name="adminID">adminID=廟宇編號 3-大甲鎮瀾宮 4-新港奉天宮 6-北港武德宮</param>
        /// </summary>
        public DataTable Getapplicantinfo_AnDouInfo(string name, string phone, int adminID, string Year)
        {
            string sql = string.Empty;
            DataTable dtGetData = new DataTable();
            ...
            {
                case 15:
                    sql = "Select * from Temple_" + Year + "..view_AnDou_Fw_InfowithAPPCharge Where AppStatus = 2 and Status = 0 and AdminID = @AdminID and (AppName = @Name and AppMobile = @Mobile)";
                    break;
                case 31:
                    sql = "Select * from Temple_" + Year + "..view_AnDou_wjsan_InfowithAPPCharge Where AppStatus = 2 and Status = 0 and AdminID = @AdminID and (AppName = @Name and AppMobile = @Mobile)";
                    break;
            }
        ...
        /// <param name="Num2String">Num2String=訂單編號</param>
        /// <param name="adminID">adminID=廟宇編號 3-大甲鎮瀾宮 4-新港奉天宮 6-北港武德宮</param>
        /// <param name="type">type=補財庫活動 1-下元補庫 2-呈疏補庫(天官武財神聖誕補財庫) 3-企業補財庫</param>
        /// </summary>
        ...
        /// <param name="phone">phone=購買人手機or祈福人手機</param>
        /// <param name="adminID">adminID=廟宇編號 3-大甲鎮瀾宮 4-新港奉天宮 6-北港武德宮</param>
        /// <param name="type">type=補財庫活動 1-下元補庫 2-呈疏補庫(天官武財神聖誕補財庫)</param>
        /// </summary>
        ...
        /// <param name="applicantID"></param>
        /// <returns></returns>
        public DataTable GetAPPCharge_Fw_AnDou(int applicantID, string Year)
        {
            string sql = "Select * from Temple_" + Year + "..view_AnDou_Fw_InfowithAPPCharge Where AppcStatus = 1 and AppStatus = 2 and Num > 0 and ApplicantID = @ApplicantID";
        ...
        /// <summary>
        /// 取得台灣道教總廟無極三清總道院安斗付款資料
        /// </summary>
        /// <param name="applicantID"></param>
        /// <returns></returns>
        public DataTable GetAPPCharge_wjsan_AnDou(int applicantID, string Year)
        {
            string sql = "Select * from Temple_" + Year + "..view_AnDou_wjsan_InfowithAPPCharge Where AppcStatus = 1 and AppStatus = 2 and Num > 0 and ApplicantID = @ApplicantID";
        ...
        /// <summary>
        /// 取得玉敕大樹朝天宮天赦日招財補運付款資料
        /// </summary>
        /// <param name="applicantID"></param>
        /// <returns></returns>
        public DataTable GetAPPCharge_ma_Supplies(int applicantID, string Year)
        {
            string sql = "Select * from Temple_" + Year + "..view_Supplies_ma_InfowithAPPCharge Where AppcStatus = 1 and AppStatus = 2 and Num > 0 and ApplicantID = @ApplicantID";
        ...
        {
            string sql = "Select * from Temple_" + Year + "..view_Supplies_Fw_InfowithAPPCharge Where AppcStatus = 1 and AppStatus = 2 and Num > 0 and ApplicantID = @ApplicantID";
        ...
        {
            string sql = "Select * from Temple_" + Year + "..view_Supplies2_sx_InfowithAPPCharge Where AppcStatus = 1 and AppStatus = 2 and Num > 0 and ApplicantID = @ApplicantID";
            ...
            switch (kind)
            {
                ...
                case "19":
                    ...
                    switch (adminID)
                    {
                        case "33":
                            //神霄玉府財神會館
                            sql = "Select * from Temple_" + Year + "..view_Supplies2_sx_InfowithAPPCharge Where AppcStatus = 1 and Transaction_id = N'" + Transaction_id + "'";
                            break;
                    }
                    break;
                case "20":
                    ...
                    switch (adminID)
                    {
                        case "15":
                            //斗六五路財神宮
                            sql = "Select * from Temple_" + Year + "..view_AnDou_Fw_InfowithAPPCharge Where AppcStatus = 1 and Transaction_id = N'" + Transaction_id + "'";
                            break;
                        case "31":
                            //台灣道教總廟無極三清總道院
                            sql = "Select * from Temple_" + Year + "..view_AnDou_wjsan_InfowithAPPCharge Where AppcStatus = 1 and Transaction_id = N'" + Transaction_id + "'";
                            break;
                    }
                    break;
            }
            ...
            switch (kind)
            {
                ...
                case "19":
                    ...
                    switch (adminID)
                    {
                        case "33":
                            //神霄玉府財神會館
                            sql = "Select Num2String, AdminID, OrderID, [Description] from Temple_" + Year + "..view_Supplies2_sx_InfowithAPPCharge Where AppcStatus = 1 and Transaction_id = N'" + Transaction_id + "'";
                            break;
                    }
                    break;
                case "20":
                    ...
                    switch (adminID)
                    {
                        case "15":
                            //斗六五路財神宮
                            sql = "Select Num2String, AdminID, OrderID, [Description] from Temple_" + Year + "..view_AnDou_Fw_InfowithAPPCharge Where AppcStatus = 1 and Transaction_id = N'" + Transaction_id + "'";
                            break;
                        case "31":
                            //台灣道教總廟無極三清總道院
                            sql = "Select Num2String, AdminID, OrderID, [Description] from Temple_" + Year + "..view_AnDou_wjsan_InfowithAPPCharge Where AppcStatus = 1 and Transaction_id = N'" + Transaction_id + "'";
                            break;
                    }
                    break;
            }
            ...
            switch (adminID)
            {
                    ...
                    switch (kind)
                    {
                        case 1:
                            switch (type)
                            {
                                ...
                                case 2:
                                    //活動-孝親祈福燈
                                    sql = "Select * from Temple_" + Year + "..ApplicantInfo_ty_mom_Lights Where ApplicantID = @aid and AdminID = " + adminID;
                                    break;
                            }
                            break;
                        case 2:
                ...
                case 15:
                    ...
                    switch (kind)
                    {
                        ...
                        case 16:
                            //補財庫
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_Fw_Supplies Where ApplicantID = @aid and AdminID = " + adminID;
                            break;
                        case 20:
                            //安斗
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_Fw_AnDou Where ApplicantID = @aid and AdminID = " + adminID;
                            break;
                    }
                    break;
                case 16:
                ...
                case 17:
                    ...
                    {
                        case 1:
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_Hs_Lights Where ApplicantID = @aid and AdminID = " + adminID;
                            break;
                    }
                    break;
                case 21:
                ...
                case 23:
                    ...
                    switch (kind)
                    {
                        ...
                        case 7:
                            //天赦日補運
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_ma_Supplies Where ApplicantID = @aid and AdminID = " + adminID;
                            break;
                        case 12:
                            //靈寶禮斗
                ...
                case 31:
                    ...
                    switch (kind)
                    {
                        ...
                        case 20:
                            //安斗
                            sql = "Select * from Temple_" + Year + "..ApplicantInfo_wjsan_AnDou Where ApplicantID = @aid and AdminID = " + adminID;
                            break;
                    }
                    break;
                case 32:
                ...
                case 15:
                    ...
                    switch (kind)
                    {
                        ...
                        case 2:
                            ...
                            break;
                        case 20:
                            sql = "Select * from Temple_" + Year + "..APPCharge_Fw_AnDou Where ApplicantID = @aid";
                            break;
                    }
                    break;
                case 16:
                ...
                case 31:
                    ...
                    switch (kind)
                    {
                        ...
                        case 2:
                            ...
                            break;
                        case 20:
                            sql = "Select * from Temple_" + Year + "..APPCharge_wjsan_AnDou Where ApplicantID = @aid";
                            break;
                    }
                    break;
                case 32:
        ...
        /// <summary>
        /// 檢查購買人是否有已付款-斗六五路財神宮安斗
        /// <param name="applecantID">applecantID=購買人編號</param>
        /// </summary>
        public bool checkedappcharge_AnDou_Fw(int applicantID, int adminID, string Year)
        {
            bool result = true;
        ...
        /// <summary>
        /// 檢查購買人是否有已付款-台灣道教總廟無極三清總道院安斗
        /// <param name="applecantID">applecantID=購買人編號</param>
        /// </summary>
        public bool checkedappcharge_AnDou_wjsan(int applicantID, int adminID, string Year)
        {
            bool result = true;
        ...
        /// <summary>
        /// 檢查購買人是否有已付款-玉敕大樹朝天宮天赦日招財補運
        /// <param name="applecantID">applecantID=購買人編號</param>
        /// </summary>
        public bool checkedappcharge_Supplies_ma(int applicantID, int adminID, string Year)
        {
            bool result = true;
        ...
        /// <summary>
        /// 檢查購買人是否有已付款-斗六五路財神宮 補財庫
        /// <param name="applecantID">applecantID=購買人編號</param>
        /// </summary>
        public bool checkedappcharge_Supplies_Fw(int applicantID, int adminID, string Year)
        {
            bool result = true;
        ...
        /// <summary>
        /// 檢查購買人是否有已付款-補財庫(呈疏補庫(天官武財神聖誕補財庫))
        /// <param name="applecantID">applecantID=購買人編號</param>
        /// </summary>
        ...
        /// </summary>
        public bool checkedAnDouNum(string AnDouType, string AdminID, int Count, int type, string Year)
        {
            bool result = false;
            string sql = string.Empty;
            DataTable dtGetData = new DataTable();
            ...
            switch (AdminID)
            {
                case "15":
                    //斗六五路財神宮
                    sql = "Select * from Temple_" + Year + "..view_AnDou_Fw_infowithAPPCharge Where AdminID = @AdminID and AnDouType = @AnDouType and AppStatus = 2 and Num > 0 and AppcStatus = 1";
                    break;
                case "31":
                    //台灣道教總廟無極三清總道院
                    sql = "Select * from Temple_" + Year + "..view_AnDou_wjsan_infowithAPPCharge Where AdminID = @AdminID and AnDouType = @AnDouType and AppStatus = 2 " +
            ...
            string andouStr = string.Empty;
            int adminid = 0;
            int acount = 0;
            string msg = string.Empty;

            andouStr = dtGetData.Rows.Count > 0 ? dtGetData.Rows[0]["AnDouString"].ToString() : "服務項目";

            if (int.TryParse(AdminID, out adminid))
            {
                DataTable dtadminInfo = objAdminDAc.GetAdminInfo(adminid);
                if (dtadminInfo.Rows.Count > 0)
                    msg = dtadminInfo.Rows[0]["Nickname"].ToString() + " " + andouStr + " 快額滿了。";
            }
            ...
            switch (AdminID)
            {
                ...
                //        case "3":
                //            //光明燈
                //            if (dtGetData.Rows.Count >= 4000 || dtGetData.Rows.Count + Count > 3306)
                //            {
                //                result = true;
                //            }

                //            acount = 4000 - dtGetData.Rows.Count;
                //            break;
                //        case "4":
                //            //安太歲
                ...
                //            checkedcount = false;
                //            acount = 500 - dtGetData.Rows.Count;
                //            break;
                //    }
                //    break;
                //case "31":
            ...
            if (acount > 0 && acount <= 50 && checkedcount)
            {
        ...
        public bool Updatecost2applicantinfo_Supplies2_sx(int ApplicantID, int AdminID, int Cost, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);
            bool bResult = false;
            ...
            if (dtDataList.Rows.Count > 0 && (int)dtDataList.Rows[0]["Status"] == 0)
            {
                ...
                bResult = objDatabaseHelper.Updateapplicantinfo_Supplies2_sx(ApplicantID, Cost, 1, Year);
            }
        ...
        public bool Updatecost2applicantinfo_Supplies_Fw(int ApplicantID, int AdminID, int Cost, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);
            bool bResult = false;
            ...
            if (dtDataList.Rows.Count > 0 && (int)dtDataList.Rows[0]["Status"] == 0)
            {
                ...
                bResult = objDatabaseHelper.Updateapplicantinfo_Supplies_Fw(ApplicantID, Cost, 1, Year);
            }
        ...
        public bool Updatecost2applicantinfo_Supplies_ma(int ApplicantID, int AdminID, int Cost, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);
            bool bResult = false;
            ...
            if (dtDataList.Rows.Count > 0 && (int)dtDataList.Rows[0]["Status"] == 0)
            {
                ...
                bResult = objDatabaseHelper.Updateapplicantinfo_Supplies_ma(ApplicantID, Cost, 1, Year);
            }
        ...
        public bool Updatecost2applicantinfo_AnDou_Fw(int ApplicantID, int AdminID, int Cost, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);
            bool bResult = false;
            ...
            if (dtDataList.Rows.Count > 0 && (int)dtDataList.Rows[0]["Status"] == 0)
            {
                ...
                bResult = objDatabaseHelper.Updateapplicantinfo_AnDou_Fw(ApplicantID, Cost, 1, Year);
            }
        ...
        public bool Updatecost2applicantinfo_AnDou_wjsan(int ApplicantID, int AdminID, int Cost, string Year)
        {
            TimeZoneInfo info = TimeZoneInfo.FindSystemTimeZoneById("Taipei Standard Time");
            DateTime dtNow = TimeZoneInfo.ConvertTime(DateTime.Now, info);
            bool bResult = false;
            ...
            if (dtDataList.Rows.Count > 0 && (int)dtDataList.Rows[0]["Status"] == 0)
            {
                ...
                bResult = objDatabaseHelper.Updateapplicantinfo_AnDou_wjsan(ApplicantID, Cost, 1, Year);
                //dtDataList.Rows[0]["Status"] = 1;
                //dtDataList.Rows[0]["Cost"] = Cost;
                //AdapterObj.Update(dtDataList);
