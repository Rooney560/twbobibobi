<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_lights_ld.aspx.cs" Inherits="twbobibobi.Temples.templeService_lights_ld" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="桃園龍德宮|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_lights_ld.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="保必保庇提供桃園龍德宮安太歲 光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" />
    <!--簡介-->
    <meta property="og:description" content="保必保庇提供桃園龍德宮安太歲 光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" />
    <!--簡介-->
    <meta property="og:site_name" content="桃園龍德宮|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/lights_ld_2026.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/lights_ld_2026.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/lights_ld_2026.jpg" />
    ...
    <title>桃園龍德宮|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
        ...
        <article id="Temple" class="page">
            ...
            <nav class="breadcrumb">
                ...
                <ul>
                    ...
                    <li><a href="https://bobibobi.tw/Temples/templeInfo.aspx?a=32" title="桃園龍德宮">桃園龍德宮</a></li>
                    <li>祈福點燈</li>
                </ul>
            </nav>
            ...
            <section>
                <div class="TempleImg">
                    <img src="https://bobibobi.tw/Temples/images/temple/lights_ld_2026.jpg" width="1160" height="550" alt="保必保庇提供桃園龍德宮安太歲光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" 
                        title="桃園龍德宮線上點燈２０２６犯太歲光明燈" />
                </div>
                <h1 class="TempleName">歡迎使用《桃園龍德宮》線上點燈服務</h1>
                <div class="TempleServiceInfo">
                    ...
                    <div class="EventServiceContent">
                        ...
                        <br />
                        <div>
                            <p>桃園龍德宮點燈服務種類多元，包含 元辰光明燈、健康延壽燈、五路財神燈、明心智慧燈、文昌功名燈、月老姻緣燈。正月開春之際，到寺廟點光明燈，有增福、晉祿、延壽之意。得受神光普照，庇佑新的一年，身體健康，元辰光采，事業興旺，財源廣進；學業有成，金榜題名；平安迪吉，前途光明。(總歸一句：福氣啦!)。</p>
                            <br />
                        ...
                        <table class="tablecontent">
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="燈種名稱">太歲燈</td>
                                    <td data-label="燈種介紹">消災賜福、神光守衛、四季禎祥、平安順遂。</td>
                                    <td data-label="燈種價格">$ 500 <span id="light2" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">元辰光明燈</td>
                                    <td data-label="燈種介紹">吉星高照、貴人圍繞、本命增輝、歲逢喜兆。</td>
                                    <td data-label="燈種價格">$ 500 <span id="light1" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">五路財神燈</td>
                                    <td data-label="燈種介紹">招寶納珍、招財利市、玄壇賜福、五路財至。</td>
                                    <td data-label="燈種價格">$ 500 <span id="light4" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">文昌功名燈</td>
                                    <td data-label="燈種介紹">學業猛進、考運得利、順風順水、三元及第。</td>
                                    <td data-label="燈種價格">$ 500 <span id="light3" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">健康延壽燈</td>
                                    <td data-label="燈種介紹">壽簿添算、否極泰來、祛病延年、植福消災。</td>
                                    <td data-label="燈種價格">$ 500 <span id="light5" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">月老姻緣燈</td>
                                    <td data-label="燈種介紹">三世鴛盟、良緣早定、夫妻恩愛、合門胥慶。</td>
                                    <td data-label="燈種價格">$ 500 <span id="light6" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">明心智慧燈</td>
                                    <td data-label="燈種介紹">心門光耀、覺性洞開、智慧過人、圓通自在。</td>
                                    <td data-label="燈種價格">$ 500 <span id="light7" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                            </tbody>
                        </table>
                        <br />
                        ...
                        <p>
                            2.個人點四盞, 加贈 
                            <a target="_blank" class="content_a" href="https://bobibobi.tw/Temples/images/temple/product/ld/002.jpg">千年江西小葉樟佛珠(看圖)</a> 一串
                        </p>
                        <br />
                        <%--<h2>※ Note：點燈者廟方附贈贈品，需自行負擔60元運費。</h2>--%>
                    ...
                    <form>
                        ...
                        <div class="FormInput select">
                            ...
                            <select name="bless_sendback_1" class="required" id="bless_sendback_1">
                                <option selected="selected" value="N">不寄回</option>
                                <option value="Y">寄回(加收運費60元)</option>
                            </select>
                        </div>
                        <div id="bless_rec_1" name="bless_rec_1" style="display: none;">
                            <div class="FormInput text_s">
                                <label>收件人姓名</label><input name="bless_rec_name_1" type="text" class="required2" id="bless_rec_name_1" placeholder="請輸入收件人姓名" />
                            </div>
                            <div class="FormInput tel">
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput select">
                                    ...
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        ...
                                        <option value="元辰光明燈">元辰光明燈 $500</option>
                                        <option value="五路財神燈">五路財神燈 $500</option>
                                        <option value="文昌功名燈">文昌功名燈 $500</option>
                                        <option value="健康延壽燈">健康延壽燈 $500</option>
                                        <option value="月老姻緣燈">月老姻緣燈 $500</option>
                                        <option value="明心智慧燈">明心智慧燈 $500</option>
                                    </select>
                                </div>
                                <div class="FormInput text_s">
...
<script>
    ...
    $("#subBtn").on("click", function () {
        ...
        // =====================================================
        // ✅ 3. 新增：購買人「贈品處理方式」與收件資料驗證
        // =====================================================
        const sendback = $("#bless_sendback_1").val();
        if (!sendback) {
            showToastAndFocus($("#bless_sendback_1"), "請選擇贈品處理方式。");
            return;
        }
        clearError($("#bless_sendback_1"));

        if (sendback === "Y") {
            const fields = [
                { id: "#bless_rec_name_1", label: "收件人姓名" },
                { id: "#bless_rec_tel_1", label: "收件人電話" },
                { id: "#bless_rec_county_1", label: "收件人縣市" },
                { id: "#bless_rec_district_1", label: "收件人鄉鎮市區" },
                { id: "#bless_rec_address_1", label: "收件人地址" }
            ];
            ...
            for (const f of fields) {
                ...
                if (!val) {
                    showToastAndFocus($input, `${f.label}未填寫，請重新輸入。`);
                    return;
                }
                clearError($input);
            }

            const recTel = $("#bless_rec_tel_1").val().trim();
            if (!Isphone(recTel)) {
                showToastAndFocus($("#bless_rec_tel_1"), "收件人電話格式錯誤。");
                return;
            }
            clearError($("#bless_rec_tel_1"));
        }
        ...
        if (checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('桃園龍德宮 2026點燈活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('桃園龍德宮 2026點燈活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
    ...
    function gotochecked(res) {
        ...
        if (res.StatusCode == 1) {
            ...
            if (res.overnumType == 3) {
                alert("元辰光明燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 4) {
                alert("太歲燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 5) {
                alert("文昌功名燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 6) {
                alert("五路財神燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 8) {
                alert("健康延壽燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 20) {
                alert("月老姻緣燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 33) {
                alert("明心智慧燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else {
    ...
    function editinfo(res) {
        ...
        if (res.StatusCode == 1) {
            ...
            if (res.AppSendback) {
                $("#bless_sendback_1").val(res.AppSendback).trigger("change");
                if (res.AppSendback == "Y") {
    ...
    function gotoChecked_ld() {
        ...
        AppSendback = $("select[name='bless_sendback_1']").val();                                   //寄送方式 N-不寄回 Y-寄回(加收運費60元)
        ReceiptName = ($("#bless_rec_name_1").val());                                               //收件人姓名
        ReceiptMobile = ($("#bless_rec_tel_1").val());                                              //收件人電話
        AppzipCode = ($("#bless_rec_zipcode_1").val());                                             //收件人郵政區號
        Appcounty = ($("select[name='bless_rec_county_1']").val());                                 //收件人縣市
        Appdist = ($("select[name='bless_rec_district_1']").val());                                 //收件人區域
        Appaddr = ($("#bless_rec_address_1").val());                                                //收件人部分地址
