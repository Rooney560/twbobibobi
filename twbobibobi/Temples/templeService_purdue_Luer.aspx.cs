    ...
    public partial class templeService_purdue_Luer : AjaxBasePage
    {
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string postURL_Init = "Purdue_Luer_Index";
                ...
                ApplicantID = objLightDAC.Addapplicantinfo_purdue_Luer(
                    Name: AppName,
                    Mobile: AppMobile,
                    Cost: "0",
                    County: Appcounty,
                ...
                if (ApplicantID > 0)
                {
                    for (int i = 0; i < listcount; i++)
                    {
                        ...
                        string purdueString = PurdueType2String(purdueType, "10");
                        string email = Jemail.Count > 0 ? Jemail[i].ToString() : "";
                        string count = Jcount.Count > 0 ? Jcount[i].ToString() : "1";
                        ...
                        int cost = GetPurdueCost(10, purdueType);
                        int amount = int.TryParse(count, out amount) ? amount : 1;

                        if (name != "")
                        {
                            purdueinfo = true;
                            PurdueID = objLightDAC.Addpurdue_Luer(
