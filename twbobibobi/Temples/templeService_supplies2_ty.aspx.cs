...
{
    public partial class templeService_supplies2_ty : AjaxBasePage
    {
        public int aid = 0;
        public int a = 0;
        public string EndDate = "2024/10/09 23:59";
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string SuppliesString_Tag = basePage.Request["SuppliesString_Tag"];         //服務項目
                ...
                JArray JSuppliesString_Tag = JArray.Parse(SuppliesString_Tag);

                string postURL = "Supplies2_ty_Index";
                ...
                postURL += basePage.Request["55"] != null ? "_55" : "";
                ...
                if (checkednum_ty)
                {
                    ...
                    ApplicantID = objLightDAC.addapplicantinfo_Supplies2_ty(AppName, AppMobile, AppBirth, "N", "吉", AppbirthMonth, Appage, AppZodiac, AppsBirth, AppEmail, "0", 
                    ...
                    if (ApplicantID > 0)
                    {
                        for (int i = 0; i < listcount; i++)
                        {
                            ...
                            string suppliesString = JSuppliesString_Tag[i].ToString(); ;
                            ...
                            {
                                suppliesinfo = true;
                                SuppliesID = objLightDAC.addSupplies2_ty(ApplicantID, name, mobile, sex, suppliesType, suppliesString, "1", Birth, leapMonth, birthTime, birthMonth, 
                    ...
                    if (ApplicantID > 0 && suppliesinfo)
                    {
                        ...
                        basePage.mJSonHelper.AddContent("redirect", "templeCheck.aspx?kind=14&a=" + AdminID + "&aid=" + ApplicantID + 
                            (basePage.Request["ad"] != null ? "&ad=1" : "") + (basePage.Request["twm"] != null ? "&twm=1" : ""));
            ...
            public void editinfo(BasePage basePage)
            {
                ...
                dtData = objLightDAC.Getsupplies2_ty_info(applicantID, Year);
