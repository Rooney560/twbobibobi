...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="台東東海龍門天聖宮|線上點燈|2025犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_lights_dh.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="保必保庇提供台東東海龍門天聖宮安太歲 光明燈線上點燈，犯太歲生肖 蛇 豬 虎 猴" />
    <!--簡介-->
    <meta property="og:description" content="保必保庇提供台東東海龍門天聖宮安太歲 光明燈線上點燈，犯太歲生肖 蛇 豬 虎 猴" />
    <!--簡介-->
    <meta property="og:site_name" content="台東東海龍門天聖宮|線上點燈|2025犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/lights_dh_2025.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/lights_dh_2025.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/lights_dh_2025.jpg" />
    ...
    <title>台東東海龍門天聖宮|線上點燈|2025犯太歲光明燈【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/lights_dh_2025.jpg" width="1160" height="550" alt="保必保庇提供台東東海龍門天聖宮安太歲光明燈線上點燈，犯太歲生肖 蛇 豬 虎 猴" 
                        title="台東東海龍門天聖宮線上點燈２０２５犯太歲光明燈" />
                </div>
                ...
                <div class="TempleServiceInfo">
                    ...
                    <div class="EventServiceContent">
                        <div>
                            <h2>光明燈</h2>
                            <p>庇佑身體健康、事業順利、鴻圖大展、心想事成、前途光明，費用500元。</p>
                        </div>

                        <div>
                            <h2>安太歲</h2>
                            <p>庇佑犯沖煞者年中逢凶化吉、一路平安、消災解厄，費用500元。</p>
                        </div>
                        
                        <div>
                            <h2>文昌燈</h2>
                            <p>又稱功名燈、可增進智慧、金榜題名、仕途順遂前途光明步步高陞，費用500元。<span id="Span1" style="color:red;" class="content_a" runat="server">(已額滿)</span></p>
                        </div>

                        <div>
                            <h2>財利燈</h2>
                            <p>財利燈又稱財祿燈、事業燈、旺財燈，祈求財源滾滾、大發利市、其仕途平坦風順、事業發達、財源廣進，費用500元。</p>
                        </div>
                        
                        <div>
                            <h2>龍王燈</h2>
                            <p>小龍年的首選,具有廣大的威力和誓願，能護持眾生增長財寶、壽命，能賜予財富、福德、功德等，一切善願圓滿，不是每間宮都點的到，費用800元。<span id="light3" style="color:red;" class="content_a" runat="server">(已額滿)</span></p>
                        </div>

                        <div>
                            <h2>虎爺燈</h2>
                            <p>求偏財、制小人、增加投資運、守護孩童、亦可守護寵物平安健康，費用500元。<span id="light4" style="color:red;" class="content_a" runat="server">(已額滿)</span></p>
                        </div>
                        <p>
                            <br />
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput select">
                                    ...
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        ...
                                        <option value="財利燈">財利燈 $500</option>
                                    </select>
                                </div>
                            </li>
