<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_lights_dh.aspx.cs" Inherits="Temple.Temples.templeService_lights_dh" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="台東東海龍門天聖宮|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_lights_dh.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="保必保庇提供台東東海龍門天聖宮安太歲 光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" />
    <!--簡介-->
    <meta property="og:description" content="保必保庇提供台東東海龍門天聖宮安太歲 光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" />
    <!--簡介-->
    <meta property="og:site_name" content="台東東海龍門天聖宮|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/lights_dh_2026.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/lights_dh_2026.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/lights_dh_2026.jpg" />
    ...
    <title>台東東海龍門天聖宮|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/lights_dh_2026.jpg" width="1160" height="550" alt="保必保庇提供台東東海龍門天聖宮安太歲光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" 
                        title="台東東海龍門天聖宮線上點燈２０２６犯太歲光明燈" />
                </div>
                <h1 class="TempleName">歡迎使用《台東東海龍門天聖宮》線上點燈服務</h1>
                <div class="TempleServiceInfo">
                    ...
                    <div class="EventServiceContent">
                        <div>
                            <h2>光明燈</h2>
                            <p>庇佑身體健康、事業順利、鴻圖大展、心想事成、前途光明，費用520元。<span id="light1" style="color:red;" class="content_a" runat="server">(已額滿)</span></p>
                        </div>

                        <div>
                            <h2>安太歲</h2>
                            <p>庇佑犯沖煞者年中逢凶化吉、一路平安、消災解厄，費用520元。<span id="light2" style="color:red;" class="content_a" runat="server">(已額滿)</span></p>
                        </div>
                        
                        <div>
                            <h2>文昌燈</h2>
                            <p>又稱功名燈、可增進智慧、金榜題名、仕途順遂前途光明步步高陞，費用520元。<span id="light3" style="color:red;" class="content_a" runat="server">(已額滿)</span></p>
                        </div>

                        <div>
                            <h2>財利燈</h2>
                            <p>財利燈又稱財祿燈、事業燈、旺財燈，祈求財源滾滾、大發利市、其仕途平坦風順、事業發達、財源廣進，費用520元。<span id="light4" style="color:red;" class="content_a" runat="server">(已額滿)</span></p>
                        </div>
                        
                        <div>
                            <h2>龍王燈</h2>
                            <p>小龍年的首選,具有廣大的威力和誓願，能護持眾生增長財寶、壽命，能賜予財富、福德、功德等，一切善願圓滿，不是每間宮都點的到，費用820元。<span id="light5" style="color:red;" class="content_a" runat="server">(已額滿)</span></p>
                        </div>

                        <div>
                            <h2>虎爺燈</h2>
                            <p>求偏財、制小人、增加投資運、守護孩童、亦可守護寵物平安健康，費用520元。<span id="light6" style="color:red;" class="content_a" runat="server">(已額滿)</span></p>
                        </div>
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput select">
                                    ...
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        ...
                                        <option value="光明燈">光明燈 $520</option>
                                        <option value="安太歲">安太歲 $520</option>
                                        <option value="文昌燈">文昌燈 $520</option>
                                        <option value="財利燈">財利燈 $520</option>
                                        <option value="龍王燈">龍王燈 $820</option>
                                        <option value="虎爺燈">虎爺燈 $520</option>
                                    </select>
                                </div>
                                <div class="FormInput text_s">
                                ...
                                <div class="FormInput date">
                                    <label>國曆生日</label><input name="bless_birthday_1" type="text" class="datapicker required2" id="bless_birthday_1" placeholder="請選擇農曆生日或國曆生日二擇一" />
                                </div>
                                <div class="FormInput select">
                                    <label>閏月</label>
...
<script>
    ...
    $("#subBtn").on("click", function () {
        ...
        if (location.search.indexOf('ad') >= 0 || checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('台東東海龍門天聖宮 2026點燈活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('台東東海龍門天聖宮 2026點燈活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
    ...
    function gotochecked(res) {
        ...
        if (res.StatusCode == 1) {
            ...
            if (res.overnumType == 3) {
                alert("光明燈 已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 4) {
                alert("安太歲 已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 5) {
                alert("文昌燈 已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 9) {
                alert("財利燈 已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 13) {
                alert("龍王燈 已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 14) {
                alert("虎爺燈 已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else {
    ...
    function gotoChecked_dh() {
        ...
        for (var i = 1; i <= listcount; i++) {
            ...
            birth_Tag.push($("#bless_birthday_" + i).val().trim());                                    //祈福人國曆生日
