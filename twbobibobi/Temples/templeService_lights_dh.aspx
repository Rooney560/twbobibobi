...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="祈福點燈|台東東海龍門天聖宮|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    ...
    <meta property="og:description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。
        ...
        福壽燈,虎爺燈,補財庫,蛇年點燈,114年點燈,2025點燈,新春點燈,錢母,發財金" />
    <!--簡介-->
    <meta property="og:site_name" content="祈福點燈|台東東海龍門天聖宮|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    ...
    <title>祈福點燈|台東東海龍門天聖宮|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/lights_dh_2025.jpg" width="1160" height="550" alt="" />
                </div>
                ...
                <div class="TempleServiceInfo">
                    ...
                    <div class="EventServiceContent">
                        ...
                        <div>
                            <h2>文昌燈</h2>
                            <p>又稱功名燈、可增進智慧、金榜題名、仕途順遂前途光明步步高陞，費用500元。</p>
                        </div>
                        ...
                        <div>
                            <h2>龍王燈</h2>
                            <p>小龍年的首選,具有廣大的威力和誓願，能護持眾生增長財寶、壽命，能賜予財富、福德、功德等，一切善願圓滿，不是每間宮都點的到，費用800元。<span id="light3" style="color:red; display: none;" class="content_a" runat="server">(已額滿)</span></p>
                        </div>

                        <div>
                            <h2>虎爺燈</h2>
                            <p>求偏財、制小人、增加投資運、守護孩童、亦可守護寵物平安健康，費用500元。</p>
                        </div>
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput select">
                                    ...
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        ...
                                        <option value="龍王燈">龍王燈 $800</option>
                                        <option value="虎爺燈">虎爺燈 $500</option>
                                    </select>
                                </div>
                            </li>
