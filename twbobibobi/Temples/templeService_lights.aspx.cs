...
{
    public partial class templeService_lights : AjaxBasePage
    {
        public int aid = 0;
        public int a = 0;
        public string EndDate = "2024/02/01 23:59";
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string LightsString_Tag = basePage.Request["LightsString_Tag"]; //燈種
