<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_lights_st.aspx.cs" Inherits="twbobibobi.Temples.templeService_lights_st" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="松柏嶺受天宮|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_lights_st.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="保必保庇提供松柏嶺受天宮安太歲 光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" />
    <!--簡介-->
    <meta property="og:description" content="保必保庇提供松柏嶺受天宮安太歲 光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" />
    <!--簡介-->
    <meta property="og:site_name" content="松柏嶺受天宮|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/lights_st_2026.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/lights_st_2026.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/lights_st_2026.jpg" />
    ...
    <title>松柏嶺受天宮|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
        ...
        <article id="Temple" class="page">
            ...
            <nav class="breadcrumb">
                ...
                <ul>
                    ...
                    <li><a href="https://bobibobi.tw/Temples/templeInfo.aspx?a=35" title="松柏嶺受天宮">松柏嶺受天宮</a></li>
                    <li>祈福點燈</li>
                </ul>
            </nav>
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/lights_st_2026.jpg?t=2589963" width="1160" height="550" alt="保必保庇提供松柏嶺受天宮安太歲光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" 
                        title="松柏嶺受天宮線上點燈２０２６犯太歲光明燈" />
                </div>
                <h1 class="TempleName">歡迎使用《松柏嶺受天宮》線上點燈服務</h1>
                <div class="TempleServiceInfo">
                    ...
                    <div class="EventServiceContent">
                        <br />
                        <h1 class="TempleName">丙午馬年線上報名點燈</h1>
                        <p>
                            松柏嶺受天宮主祀玄天上帝，為全台玄天上帝信仰重鎮之一，香火鼎盛、靈驗有求必應。每年吸引無數信眾前來參拜祈福，祈求事業順利、身體健康、家庭平安。
                        </p>
                        <p>
                            為了讓更多無法親自前來的信眾也能誠心獻燈祈福，受天宮特別開放「線上點燈」服務。無論您身在何處，只要透過本頁填寫報名資訊，即可為自己與親友點燈祈願，神明照護全年安泰。
                        </p>
                        <br />
                        <div class="TempleImg">
                            <img src="images/temple/lights-04_st_2026.jpg?t=2589963" width="600" alt="保必保庇松柏嶺受天宮２０２６線上點燈 安奉太歲" title="保必保庇松柏嶺受天宮２０２６線上點燈 安奉太歲" />
                            <span id="light2" style="color:red;" class="content_a" runat="server">(已額滿)</span>
                        </div>
                        <br />
                        <div class="TempleImg">
                            <img src="images/temple/lights-03_st.jpg?t=2589963" width="600" alt="保必保庇松柏嶺受天宮２０２６線上點燈 光明燈" title="保必保庇松柏嶺受天宮２０２６線上點燈 光明燈" />
                            <span id="light1" style="color:red;" class="content_a" runat="server">(已額滿)</span>
                        </div>
                        <br />
                        <div class="TempleImg">
                            <img src="images/temple/lights-05_st.jpg?t=2589963" width="600" alt="保必保庇松柏嶺受天宮２０２６線上點燈 文昌燈" title="保必保庇松柏嶺受天宮２０２６線上點燈 文昌燈" />
                            <span id="light3" style="color:red;" class="content_a" runat="server">(已額滿)</span>
                        </div>
                        <br />
                        <div class="TempleImg">
                            <img src="images/temple/lights-06_st.jpg?t=2589963" width="600" alt="保必保庇松柏嶺受天宮２０２６線上點燈 財神燈" title="保必保庇松柏嶺受天宮２０２６線上點燈 財神燈" />
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput select">
                                    ...
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        ...
                                        <option value="安奉太歲">安奉太歲 $500</option>
    ...
    $("#subBtn").on("click", function () {
        ...
        if (checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('松柏嶺受天宮 2026點燈活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('松柏嶺受天宮 2026點燈活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
