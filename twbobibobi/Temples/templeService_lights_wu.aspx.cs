...
namespace Temple.Temples
{
    public partial class templeService_lights_wu : AjaxBasePage
    {
        public int aid = 0;
        public int a = 0;
        public string EndDate = "2024/02/04 23:59";
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string postURL = "Lights_wu_Index";
                ...
                //string[] Lightstypelist = new string[] { "3", "4", "6" };
                //for (int i = 0; i < 3; i++)
                //{
                ...
                {
                    if (objLightDAC.checkedLightsNum(GetLightsType(JLightsString_Tag[i].ToString(), "6"), AdminID.ToString(), count_wu_lights[i], -1, Year))
                    {
                        checkednum_wu = false;
                ...
                if (checkednum_wu)
                {
                    ApplicantID = objLightDAC.addapplicantinfo_lights_wu(AppName, AppMobile, "0", "", "", "", "0", "N", "", "", 0, AdminID, postURL, Year);
