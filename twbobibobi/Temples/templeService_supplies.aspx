...
<head runat="server">
    ...
    <meta property="og:title" content="下元補庫|北港武德宮|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    ...
    <!--簡介-->
    <meta property="og:site_name" content="下元補庫|北港武德宮|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/supplies_wu_2024.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/supplies_wu_2024.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/supplies_wu_2024.jpg" />
    ...
    <title>下元補庫|北港武德宮|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/supplies_wu_2024.jpg" width="1160" height="550" alt="" />
                </div>
                <h1 class="TempleName">北港武德宮</h1>
                <div class="TempleServiceInfo">
                    <div class="EventTime">
                        <div>活動開始日期：</div>
                        <div id="startTime">2024/10/01 00:00</div>
                        <br />
                        <div>活動截止日期：</div>
                        <div id="endTime">2024/11/10 23:59</div>
                    </div>
                    <div class="EventServiceContent">
                        ...
                        <div>
                            <h2>▌注意事項</h2>
                            <p>報名完成後,保必保庇會在11/10號統一將報名資料給予北港武德宮，於農曆十月十五日子時(11/15 23:15~)，北港武德宮管理委員將舉行水官大帝聖誕祝壽團拜，同時為遠距善信祈補財庫，完成後廟方會寄送感謝狀至您的收件地址.</p>
                        </div>
                        <div>
                        ...
                        <ul class="InputGroup">
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput date birth">
                                    <label>農曆生日</label><input name="bless_birthday_1" type="text" class="datapicker required" id="bless_birthday_1" placeholder="請選擇農曆生日"/>
                                </div>
