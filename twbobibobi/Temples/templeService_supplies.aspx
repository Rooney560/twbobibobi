<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_supplies.aspx.cs" Inherits="Temple.Temples.templeService_supplies" %>
...
<head runat="server">
    ...
    <meta property="og:title" content="北港武德宮|下元補庫|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_supplies.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:site_name" content="北港武德宮|下元補庫|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/supplies_wu_2025.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/supplies_wu_2025.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/supplies_wu_2025.jpg" />
    ...
    <title>北港武德宮|下元補庫|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/supplies_wu_2025.jpg" width="1160" height="550" alt="保必保庇提供松北港武德宮下元補庫線上報名服務" title="保必保庇提供松北港武德宮下元補庫線上報名服務" />
                </div>
                <h1 class="TempleName">歡迎使用《北港武德宮》下元補庫服務</h1>
                <div class="TempleServiceInfo">
                    <div class="EventTime">
                        <div>活動開始日期：</div>
                        <div id="startTime">2025/10/09 00:00</div>
                        <br />
                        <div>活動截止日期：</div>
                        <div id="endTime">2025/11/26 23:59</div>
                    </div>
                    <div class="EventServiceContent">
                        ...
                        <div>
                            <h2>▌下元補庫 水官解厄</h2>
                            <p>下元三品水官大帝主解厄，當我們受災障業果束縛時，如種子受髒污油垢包覆，若不用心滌淨，則再怎麼澆灌，都難以生長並茁壯，是以除了正月十五求天官賜福、三月十五求武財公賜財外，地官水官聖誕亦須恭誠敬奉，祈求地官去“因”，水官化“果”，因業的束縛減弱或去除後，屆時再祈求武財公賜財補庫，方收事半功倍之效。</p>
                        </div>
                        <div>
                            <h2>▌注意事項</h2>
                            <p>報名完成後,保必保庇會在11/26號統一將報名資料給予北港武德宮，於農曆十月十五日子時(12/04 23:15~)，北港武德宮管理委員將舉行水官大帝聖誕祝壽團拜。</p>
                        </div>
                        <div>
                            <h2>補財庫-下元補庫 $650 /份</h2>
                        </div>
                    </div>
                </div>
                ...
                <div class="OrderForm">
                    <form>
                        ...
                        <div class="FormInput mail">
                            <label>購買人信箱</label><input name="member_mail" type="text" class="required" id="member_mail" placeholder="請輸入購買人信箱(必填)"/>
                        </div>
                        <div class="FormInput">
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput select">
                                    ...
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        <option value="1">下元補庫 ($650)</option>
                                    </select>
                                </div>
                                <div class="FormInput text_s">
    ...
    $("#subBtn").on("click", function () {
        ...
        if (checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('北港武德宮 2025下元補庫活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('北港武德宮 2025下元補庫活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
