<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_lights_h.aspx.cs" Inherits="Temple.Temples.templeService_lights_h" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="新港奉天宮|線上點燈|2025犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_lights_h.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="保必保庇提供新港奉天宮安太歲 光明燈線上點燈，犯太歲生肖 蛇 豬 虎 猴" />
    <!--簡介-->
    <meta property="og:description" content="保必保庇提供新港奉天宮安太歲 光明燈線上點燈，犯太歲生肖 蛇 豬 虎 猴" />
    <!--簡介-->
    <meta property="og:site_name" content="新港奉天宮|線上點燈|2025犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/lights_h.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/lights_h.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/lights_h.jpg" />
    ...
    <title>新港奉天宮|線上點燈|2025犯太歲光明燈【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/lights_h_2025.jpg" width="1160" height="550" alt="保必保庇提供新港奉天宮安太歲光明燈線上點燈，犯太歲生肖 蛇 豬 虎 猴" 
                        title="新港奉天宮線上點燈２０２５犯太歲光明燈" />
                </div>
                <h1 class="TempleName">歡迎使用《新港奉天宮》線上點燈服務</h1>
                <div class="TempleServiceInfo">
                    ...
                    <div class="EventServiceContent">
                        <h2>農曆元月十五號前預約點燈的民眾 將於 元宵節 國曆2月12日(大年初十五)實體點燈。</h2>
                        <h2>農曆元月十五號之後參加的民眾將於 元宵節後陸續進行實體點燈。</h2>
                        <br />
                        <div>
                            <h2>光明燈</h2>
                            <p>年節過後，乍暖還寒；莘莘學子的考試接踵而來，上班族或歷經轉職，或開工衝刺，想要學業進步、考試順利、前途光明嗎？ 點光明燈，有照耀前途之意，
                                祈願並期勉在未來一年精神昂揚，奮力進取。想祈求前途光明、解厄消災、啟迪智慧、學業進步、元辰光彩、身體康泰、諸事吉順的水水，都可以點光明燈，
                                費用620元。<span id="light1" style="color:red; display: none;">(已額滿)</span></p>
                        </div>

                        <div>
                            <h2>安太歲</h2>
                            <p>太歲星君俗稱太歲或歲君，負責 掌管人間的吉凶禍福。古人有：「太歲當頭坐，無喜必有禍。太歲出現來，無病恐破財」的俗諺。 本命生肖與值年太歲相沖，
                                或相隔六年（叫對沖或偏沖），或是年紀尾數見九時就是俗稱的「犯太歲」，因此為了要趨吉避凶必須「安太歲」，以祈求來年平安，事業順利，費用620元。
                                <span id="light2" style="color:red; display: none;">(已額滿)</span></p>
                        </div>
                        <div class="TempleImg">
                            <img src="images/temple/lights_h_01_2025.png?=852963" width="1160" height="550" alt="" />
                        </div>
                        <br />
                        <div>
                            <h2>摸彩券-新港奉天宮 在 2025/01/31 前點燈民眾將隨感謝狀寄出蛇年抽獎券，請在活動截止前填妥資訊並寄回 新港奉天宮，將可參加抽獎。</h2>
                        </div>
                        <div class="TempleImg">
                            <img src="images/temple/lights_h_02_2025.jpg?=852963" width="1160" height="550" alt="" />
                        </div>
                        <p>
                            <br />
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput select">
                                    ...
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        ...
                                        <option value="安太歲">安太歲 $620</option>
                                    </select>
                                </div>
                            </li>
