    ...
    public partial class templeService_lights_Fu : AjaxBasePage
    {
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string postURL = "Lights_Fu_Index";
                ...
                postURL += basePage.Request["fbFu"] != null ? "_FBFU" : "";
                ...
                postURL += basePage.Request["inFu"] != null ? "_INFU" : "";

                postURL += basePage.Request["elv"] != null ? "_ELV" : "";

                ApplicantID = objLightDAC.addapplicantinfo_lights_Fu(AppName, AppMobile, "0", "", "", "", "0", "N", "", "", 0, AdminID, postURL, Year);
                ...
                if (ApplicantID > 0)
                {
                    for (int i = 0; i < listcount; i++)
                    {
                        ...
                        {
                            lightsinfo = true;
                            LightsID = objLightDAC.addLights_Fu(ApplicantID, name, mobile, sex, lightsType, lightsString,
