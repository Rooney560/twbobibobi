...
{
    public partial class templeService_qnlight_ty : AjaxBasePage
    {
        public int aid = 0;
        public int a = 0;
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string QnLightString_Tag = basePage.Request["QnLightString_Tag"];                     //服務項目
                ...
                JArray JQnLightString_Tag = JArray.Parse(QnLightString_Tag);

                string postURL_Init = "QnLight_ty_Index";
                ...
                if (checkednum_ty)
                {
                    ...
                    ApplicantID = objLightDAC.Addapplicantinfo_qnlight_ty(
                        AdminID, 
                        AppName, 
                        AppMobile, 
                        "0", 
                    ...
                    if (ApplicantID > 0)
                    {
                        for (int i = 0; i < listcount; i++)
                        {
                            ...
                            string qnlightString = JQnLightString_Tag[i].ToString(); ;
                            string qnlightType = GetQnLightType(qnlightString, "14");
                            ...
                            {
                                qnlightinfo = true;
                                QnLightID = objLightDAC.AddQnLight_ty(
            ...
            public void editinfo(BasePage basePage)
            {
                ...
                dtData = objLightDAC.Getqnlight_ty_Info(applicantID, Year);
