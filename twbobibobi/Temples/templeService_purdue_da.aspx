...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="中元普度|大甲鎮瀾宮|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    ...
    <!--簡介-->
    <meta property="og:site_name" content="中元普度|大甲鎮瀾宮|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    ...
    <title>中元普度|大甲鎮瀾宮|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/purdue_da.jpg" width="1160" height="550" alt="" />
                </div>
                ...
                <div class="TempleServiceInfo">
                    <div class="EventTime">
                        ...
                        <br />
                        <div>活動截止日期：</div>
                        <div id="endTime">2024/08/07 23:59</div>
                    </div>
    ...
    $("#subBtn").on("click", function () {
        ...
        for (var i = 1; i <= listcount; i++) {
            ...
            if ($("#bless_service_" + i).val() == 3) {
                // 遍歷每個必填欄位-有條件 (普度項目=亡者)
                var reslist = ["bless_death_name_" + i, "bless_death_birthday_" + i, "bless_death_deathday_" + i];
            ...
            if ($("#bless_service_" + i).val() == 2 || $("#bless_service_" + i).val() == 6) {
                // 遍歷每個必填欄位-有條件 (普度項目=九玄七祖 or 嬰靈)
                var reslist = ["bless_first_name_" + i];
