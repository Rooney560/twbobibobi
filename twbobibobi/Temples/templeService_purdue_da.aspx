<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_purdue_da.aspx.cs" Inherits="Temple.Temples.templeService_purdue_da" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="大甲鎮瀾宮|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_purdue_da.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:site_name" content="大甲鎮瀾宮|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/purdue_da.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/purdue_da.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/purdue_da.jpg" />
    ...
    <title>大甲鎮瀾宮|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/purdue_da_2025.jpg" width="1160" height="550" alt="大甲鎮瀾宮|中元普度" title="大甲鎮瀾宮|中元普度" />
                </div>
                <h1 class="TempleName">大甲鎮瀾宮</h1>
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput select">
                                    ...
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        ...
                                        <option value="3">指名亡者 $620</option>
                                        <option value="4">本境地基主 $620</option>
                                        <option value="2">O家堂上歷代九玄七祖 $620</option>
                                        <option value="6">O家嬰靈 $620</option>
                                        <option value="5">冤親債主 $620</option>
                                        <option value="7">為國捐軀三軍將士英靈 $620</option>
                                        <option value="8">鐵公路車傷死亡眾魂 $620</option>
                                        <option value="9">本境水難傷亡諸魂 $620</option>
                                        <option value="10">本境男女無嗣孤魂等眾 $620</option>
                                        <option value="11">六畜往生 $620</option>
                                    </select>
                                </div>
                                <div class="FormInput text_s">
                                    ...
                                    <div id="bless_zamp_1" name="bless_zamp_1" style="display:none;">
                                        <div class="FormInput select">
                                            ...
                                            <select name="bless_sendback_1" class="required" id="bless_sendback_1">
                                                <option selected="selected" value="0">不寄回(會轉送給弱勢團體)</option>
                                                <option value="1">寄回(加收運費250元)</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="Salvation">
                                    <div id="bless_death_1" name="bless_death_1">
                                        <div class="FormInput text_s">
                                            <label>亡者姓名</label><input name="bless_death_name_1" type="text" class="required3" id="bless_death_name_1" placeholder="請輸入亡者姓名" />
                                        </div>
                                        <div class="FormInput date">
                                            <label>亡者農歷生日</label><input name="bless_death_birthday_1" type="text" class="datapicker required3" id="bless_death_birthday_1" placeholder="請選擇亡者生日" />
                                        </div>
                                        ...
                                        <div class="FormInput date">
                                            <label>亡者死亡日期</label><input name="bless_death_deathday_1" type="text" class="datapicker required3" id="bless_death_deathday_1" placeholder="請選擇亡者死亡日期(國歷)" />
                                        </div>
                                    </div>
                            ...
                            if (value != '') {
                                switch (value) {
                                    case "1":
                                        ...
                                        $(".Salvation #bless_death_" + id).hide();
                                        $(".Salvation #bless_firstname_" + id).hide();
                                        break;
                                    case "2":
                                        //九玄七祖
                                        $("#zampname2_" + id).show();
...
<script>
    ...
    function validateBless(i) {
        ...
        // 遍歷每個必填欄位-有條件 (寄回欄位=1)
        if ($li.find(`#bless_sendback_${i}`).val() === "1") {
            // 要驗證的欄位 key 與對應顯示文字
            var fields = [
                { key: "name", label: "姓名" },
                { key: "tel", label: "電話" },
            ...
            for (var j = 0; j < fields.length; j++) {
                var f = fields[j];
                // 對應到 DOM id
                var $input = $li.find(`#bless_rec_${f.key}_${i}`);
                var val = $input.val() == null ? "" : $input.val().trim();

                if (!val) {
                    // 只要有一個空就跳出並 focus
                    showToastAndFocus($input, `收件人${f.label}為空，請重新輸入。`);
                    return false;
                }
                // 通過才清掉先前錯誤
                clearError($input);
        ...
        // 遍歷每個必填欄位-有條件 (普度項目=九玄七祖 or 嬰靈)
        if ($li.find(`#bless_service_${i}`).val() === "2" || $li.find(`#bless_service_${i}`).val() === "6") {
            const firstname = $li.find(`#bless_first_name_${i}`).val();
            if (!firstname) {
                showToastAndFocus($li.find(`#bless_first_name_${i}`), "姓氏 為空，請重新輸入。");
                return false;
            }
            clearError($li.find(`#bless_first_name_${i}`));
        }

        // 遍歷每個必填欄位-有條件 (普度項目=指名亡者)
        if ($li.find(`#bless_service_${i}`).val() === "3") {
            // 要驗證的欄位 key 與對應顯示文字
            var fields = [
                { key: "death_name", label: "亡者姓名" },
                { key: "death_birthday", label: "亡者農歷生日" },
                { key: "death_deathday", label: "亡者死亡日期" }
            ];
            for (var j = 0; j < fields.length; j++) {
                var f = fields[j];
                // 對應到 DOM id
        ...
        // 遍歷每個必填欄位-有條件 (普度項目=冤親債主)
        if ($li.find(`#bless_service_${i}`).val() === "5") {
            const name2 = $li.find(`#bless_name2_${i}`);
            name2.text("");
        }
    ...
    $("#subBtn").on("click", function () {
        ...
        if (checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('大甲鎮瀾宮 2025普度活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('大甲鎮瀾宮 2025普度活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
        ...
        if (res.StatusCode == 1) {
            ...
            if (res.DataSource != null) {
                $.each(res.DataSource, function (i, item) {
                    ...
                    if (item.PurdueType == '2' || item.PurdueType == '6') {
                        $("#bless_first_name_" + index).val(item.FirstName);
                    }
                    else if (item.PurdueType == "1") {
    ...
    function gotoChecked_da() {
        ...
        for (var i = 1; i <= listcount; i++) {
            ...
            //birth_Tag.push($("#bless_birthday_" + i).val('')rim());                                    //祈福人農曆生日
            ...
            birth_Tag.push('');
            leapMonth_Tag.push('N');
            birthtime_Tag.push('吉');
            sbirth_Tag.push('');
            ...
            sendback_Tag.push(sendback);                                                               //寄送方式 0-不寄回(會轉送給弱勢團體) 1-寄回(加收運費250元)
            ...
            deathname_Tag.push($("#bless_death_name_" + i).val());                              //亡者姓名
            deathbirth_Tag.push($("#bless_death_birthday_" + i).val());                         //亡者農歷生日
            deathleapMonth_Tag.push($("#bless_death_leapMonth_" + i).val());                    //閏月 Y-是 N-否
            deathbirthtime_Tag.push($("#bless_death_birthtime_" + i).val());                    //農曆時辰
            deathday_Tag.push($("#bless_death_deathday_" + i).val());                           //亡者死亡日期
...
<script>
    $("#bless_service_1").on("change", function () {
        ...
        switch (value) {
            case "1":
                ...
                $(".Salvation #bless_death_1").hide();
                $(".Salvation #bless_firstname_1").hide();
                break;
            case "2":
                //九玄七祖
                $("#zampname2_1").show();
    ...
    $("#bless_sendback_1").on("change", function () {
        ...
        const $li = $(`.InputGroup > li[bless-id=1]`);

        const fields = [
            { key: 'rec_name', container: 'bless_rec' },                    // 收件人姓名
            { key: 'rec_tel', container: 'bless_rec' },                     // 收件人電話
            { key: 'rec_county', container: 'bless_rec' },                  // 收件人地址 縣市
            { key: 'rec_district', container: 'bless_rec' },                // 收件人地址 區域
            { key: 'rec_address', container: 'bless_rec' },                 // 收件人地址 部分地址
            { key: 'rec_zipcode', container: 'bless_rec' }                  // 收件人地址 郵遞區號
        ];

        fields.forEach(f => {
            // 1) 清空 input/select
            const $input = $li.find(`#bless_${f.key}_1`);
            if ($input.is('select')) {
    ...
    function templeinit(id) {
        ...
        const fields = [
            { key: 'death_name', container: 'bless_death' },                // 指名亡者姓名
            { key: 'death_birthday', container: 'bless_death' },            // 農曆生日
            { key: 'death_deathday', container: 'bless_death' },            // 往生日期
            { key: 'first_name', container: 'bless_firstname' },            // 祖先姓氏 / 嬰靈姓氏
            { key: 'sendback', container: 'bless_zamp' },                   // 贈品處理方式
            { key: 'rec_name', container: 'bless_rec' },                    // 收件人姓名
            { key: 'rec_tel', container: 'bless_rec' },                     // 收件人電話
            { key: 'rec_county', container: 'bless_rec' },                  // 收件人地址 縣市
            { key: 'rec_district', container: 'bless_rec' },                // 收件人地址 區域
