<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_huaguo_wjsan.aspx.cs" Inherits="twbobibobi.Temples.templeService_huaguo_wjsan" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="台灣道教總廟無極三清總道院|供花供果|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_huaguo_wjsan.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="保必保庇提供台灣道教總廟無極三清總道院供花/供果線上報名服務" />
    <!--簡介-->
    <meta property="og:description" content="保必保庇提供台灣道教總廟無極三清總道院供花/供果線上報名服務" />
    <!--簡介-->
    <meta property="og:site_name" content="台灣道教總廟無極三清總道院|供花供果|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/huaguo_wjsan_2025.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/huaguo_wjsan_2025.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/huaguo_wjsan_2025.jpg" />
    ...
    <title>台灣道教總廟無極三清總道院|供花供果|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/huaguo_wjsan_2025.jpg?t=2589963" width="1160" height="550" alt="保必保庇提供台灣道教總廟無極三清總道院供花/供果線上報名服務" 
                        title="台灣道教總廟無極三清總道院供花/供果線上報名服務" />
                </div>
                <h1 class="TempleName">歡迎使用《台灣道教總廟無極三清總道院》供花/供果線上報名服務</h1>
                <div class="TempleServiceInfo">
                    <div class="EventTime" style="display: none;">
                        <div>活動開始日期：</div>
                        <div id="startTime">2025/05/01 00:00</div>
                        <br />
                        <div>活動截止日期：</div>
                        <div id="endTime">2025/12/31 23:59</div>
                    </div>
                    <div class="EventServiceContent">
                        <p>忙碌生活沒時間拜拜？我們幫你搞定！<br />
                            【初一十五代供花果服務】 由廟方誠心代購上供鮮花、供果 會幫你寫疏文上秉 , 為您祈求平安順利、好運連連。誠心托付，一樣靈驗！</p>
                    </div>
                    <div class="TempleImg">
                        <img src="images/temple/huaguo_wjsan01.jpg?t=2589963" width="1160" height="550" alt="保必保庇提供台灣道教總廟無極三清總道院供花" 
                            title="保必保庇提供台灣道教總廟無極三清總道院供花" />
                        <img src="images/temple/huaguo_wjsan02.jpg?t=2589963" width="1160" height="550" alt="保必保庇提供台灣道教總廟無極三清總道院供花之道教意思" 
                            title="保必保庇提供台灣道教總廟無極三清總道院供果之道教意思" />
                        <img src="images/temple/huaguo_wjsan03.jpg?t=2589963" width="1160" height="550" alt="保必保庇提供台灣道教總廟無極三清總道院十功德" 
                            title="保必保庇提供台灣道教總廟無極三清總道院十功德" />
                        <img src="images/temple/huaguo_wjsan04.jpg?t=2589963" width="1160" height="550" alt="保必保庇提供台灣道教總廟無極三清總道院供果" 
                            title="保必保庇提供台灣道教總廟無極三清總道院供果" />
                        <img src="images/temple/huaguo_wjsan05.jpg?t=2589963" width="1160" height="550" alt="保必保庇提供台灣道教總廟無極三清總道院供花/供果" 
                            title="台灣道教總廟無極三清總道院供花/供果" />
                        <img src="images/temple/huaguo_wjsan06.jpg?t=2589963" width="1160" height="550" alt="保必保庇提供台灣道教總廟無極三清總道院活動時間" 
                            title="保必保庇提供台灣道教總廟無極三清總道院活動時間" />
                    </div>
                    <div class="EventServiceContent">
                    ...
                    <form>
                        ...
                        <ul class="InputGroup">
                            ...
                            <li bless-id="1">
                                ...
                                <div>（祈福人限填一位，每種供花供果項目對應一位祈福人。如需多位，請點選增加祈福人。）</div>
                                <div class="FormInput select">
                                    <label>活動項目</label>
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        <option value>請選擇</option>
                                        <option value="供花/次">供花/次 $500</option>
                                        <option value="供果/次">供果/次 $600</option>
                                        <option value="供花/月">供花/月 $1000</option>
                                        <option value="供果/月">供果/月 $1200</option>
                                        <option value="供花/半年">供花/半年 $6000</option>
                                        <option value="供果/半年">供果/半年 $7200</option>
                                    </select>
                                </div>
                                <div class="FormInput text_s">
...
<script>
    $("#subBtn").on("click", function () {
        ...
        var value_appdist = $("#member_district").val();
        if (value == "") {
        ...
        else if (value_appdist == '' || value_appdist == null) {
            ...
            if (isValid4) {
                ...
                if (value_appdist != '' && $("#member_district").hasClass('unfilled')) {
        ...
        if (res.StatusCode == 1) {
            ...
            if (res.DataSource != null) {
                $.each(res.DataSource, function (i, item) {
                    ...
                    $("#bless_service_" + index).val(item.HuaguoString);
    ...
    function gotoChecked_wjsan() {
        ...
        for (var i = 1; i <= listcount; i++) {
            ...
            HuaguoString_Tag.push($("#bless_service_" + i).val().trim());                              //服務項目
        }
        ...
        data = {
            ...
            HuaguoString_Tag: JSON.stringify(HuaguoString_Tag),
            listcount: listcount
        };
