...
{
    public partial class templeComplete_in : AjaxBasePage
    {
                ...
                if (Request["a"] != null && Request["aid"] != null)
                {
                    ...
                    switch (kind)
                    {
                        case 1:
                            ...
                            switch (adminID)
                            {
                                case 3:
                                    //大甲鎮瀾宮
                                    title = "大甲鎮瀾宮";
                                    GetStateContentlist_da(adminID, ApplicantID, kind, Year);       //申請人資料列表
                                    EndDate = "2024/10/30 23:59";
                                    break;
                                case 4:
                                    //新港奉天宮
                                    title = "新港奉天宮";
                                    GetStateContentlist_h(adminID, ApplicantID, kind, Year);          //申請人資料列表
                                    EndDate = "2024/10/31 23:59";
                                    break;
                                case 6:
                                    //北港武德宮
                                    title = "北港武德宮";
                                    GetStateContentlist_wu(adminID, ApplicantID, kind, Year);          //申請人資料列表
                                    EndDate = "2024/02/04 23:59";
                                    break;
                                case 8:
                                    //西螺福興宮
                                    title = "西螺福興宮";
                                    GetStateContentlist_Fu(adminID, ApplicantID, kind, Year);       //申請人資料列表
                                    EndDate = "2024/10/31 23:59";
                                    break;
                                case 10:
                                    //台南正統鹿耳門
                                    title = "台南正統鹿耳門聖母廟";
                                    GetStateContentlist_Luer(adminID, ApplicantID, kind, Year);       //申請人資料列表
                                ...
                                case 14:
                                    ...
                                    {
                                        //一般點燈
                                        GetStateContentlist_ty(adminID, ApplicantID, kind, Year);       //申請人資料列表
                                        EndDate = "2024/10/31 23:59";
                                    }
                                    else if (type == 2)
                                    {
                                        //孝親祈福燈
                                        GetStateContentlist_ty_mom(adminID, ApplicantID, kind, Year);       //申請人資料列表
                                        EndDate = "2024/05/09 23:59";
                                    }
                                    break;
                                case 15:
                                    //斗六五路財神宮
                                    title = "斗六五路財神宮";
                                    GetStateContentlist_Fw(adminID, ApplicantID, kind, Year);       //申請人資料列表
                                    EndDate = "2024/10/31 23:59";
                                    break;
                                case 16:
                                    //東海龍門天聖宮
                                    title = "台東東海龍門天聖宮";
                                    GetStateContentlist_dh(adminID, ApplicantID, kind, Year);       //申請人資料列表
                                    EndDate = "2024/10/31 23:59";
                                    break;
                                case 17:
                                    //五股賀聖宮
                                    title = "五股賀聖宮";
                                    GetStateContentlist_Hs(adminID, ApplicantID, kind, Year);       //申請人資料列表
                                    EndDate = "2024/02/01 23:59";
                                    break;
                                case 18:
                                    //外澳接天宮
                                    title = "外澳接天宮";
                                    GetStateContentlist_Jt(adminID, ApplicantID, kind, Year);       //申請人資料列表
                                    EndDate = "2024/02/01 23:59";
                                    break;
                                case 19:
                                    //安平開台天后宮
                                    title = "安平開台天后宮";
                                    GetStateContentlist_Am(adminID, ApplicantID, kind, Year);       //申請人資料列表
                                    EndDate = "2024/02/01 23:59";
                                    break;
                                case 21:
                                    //鹿港城隍廟
                                    title = "鹿港城隍廟";
                                    GetStateContentlist_Lk(adminID, ApplicantID, kind, Year);       //申請人資料列表
                                    EndDate = "2024/10/31 23:59";
                                    break;
                            }
                            break;
                        case 2:
                            ...
                            switch (adminID)
                            {
                                ...
                                case 9:
                                    //桃園大廟景福宮
                                    title = "桃園大廟景福宮";
                                    //GetStateContentlist_Jing(adminID, ApplicantID);                     //申請人資料列表
                                ...
                                case 23:
                                    //玉敕大樹朝天宮
                                    title = "玉敕大樹朝天宮";
                                    GetStateContentlist_ma(adminID, ApplicantID, kind, Year);           //申請人資料列表
                                    EndDate = "2024/08/04 23:59";
                                    break;
                                case 30:
                                    //鎮瀾買足
                                    title = "大甲鎮瀾宮";
                                    GetStateContentlist_mazu(adminID, ApplicantID, kind, Year);         //申請人資料列表
                                    EndDate = "2024/08/15 23:59";
                                    break;
                            }
                        ...
                        case 3:
                            ...
                            //        //商品小舖
                            //        title = "文創商品販賣小舖";
                            //        GetPurchaserlist_da(adminID, ApplicantID);          //申請人資料列表
                ...
                case 1:
                    ...
                    if (dtData.Rows.Count > 0)
                    {
                        ...
                        for (int i = 0; i < dtData.Rows.Count; i++)
                        {
                            ...
                            OrderInfo += OrderData("時辰", dtData.Rows[i]["Birth"].ToString() == "" ? "吉" : dtData.Rows[i]["Birth"].ToString());
            ...
            switch (kind)
            {
                ...
                case 2:
                    ...
                    if (dtData.Rows.Count > 0)
                    {
                        ...
                        OrderPurchaser += OrderData("申請人信箱", dtData.Rows[0]["AppEmail"].ToString());
                        OrderPurchaser += OrderData("申請人地址", dtData.Rows[0]["AppAddress"].ToString());
        ...
        //申請人資料列表-桃園威天宮
        public void GetStateContentlist_ty(int AdminID, int ApplicantID, int kind, string Year)
        {
            LightDAC objLightDAC = new LightDAC(this);
            ...
            switch (kind)
            {
                ...
                case 7:
                    ...
                    if (dtData.Rows.Count > 0)
                    {
                        ...
                        OrderPurchaser += OrderData("申請人地址", (dtData.Rows[0]["AppZipCode"].ToString() != "" ? dtData.Rows[0]["AppZipCode"].ToString() + " " : "") + dtData.Rows[0]["AppAddress"].ToString());
                ...
                case 9:
                    ...
                    if (dtData.Rows.Count > 0)
                    {
                        ...
                        OrderPurchaser += OrderData("申請人電話", dtData.Rows[0]["AppMobile"].ToString());
                        OrderPurchaser += OrderData("國曆生日", dtData.Rows[0]["AppBirth"].ToString() + (dtData.Rows[0]["AppLeapMonth"].ToString() == "Y" ? " 閏月" : ""));
                        OrderPurchaser += OrderData("申請人Email", dtData.Rows[0]["AppEmail"].ToString());
                        OrderPurchaser += OrderData("申請人地址", (dtData.Rows[0]["AppZipCode"].ToString() != "" ? dtData.Rows[0]["AppZipCode"].ToString() + " " : "") + dtData.Rows[0]["AppAddress"].ToString());
        ...
        //申請人資料列表-桃園威天宮孝親祈福燈
        public void GetStateContentlist_ty_mom(int AdminID, int ApplicantID, int kind, string Year)
        {
            LightDAC objLightDAC = new LightDAC(this);
            ...
            if (dtData.Rows.Count > 0)
            {
                ...
                for (int i = 0; i < dtData.Rows.Count; i++)
                {
                    ...
                    //服務項目金額
                    int cost = GetLightsCost(AdminID, lightsType);
                    OrderInfo += "<div>$ " + cost + "元</div>";
                    Total += cost;
        ...
        public void GetStateContentlist_Hs(int AdminID, int ApplicantID, int kind, string Year)
        {
            ...
            switch (kind)
            {
                case 1:
                    ...
                    //case 2:
                    //    //普度服務
                    //    dtData = objLightDAC.GetAPPCharge_Hs_Purdue(ApplicantID, Year);
                    //    if (dtData.Rows.Count > 0)
                    //    {
                    //        OrderStateContent = OrderState("付款時間", DateTime.Parse(dtData.Rows[0]["ChargeDate"].ToString()).ToString("yyyy-MM-dd HH:mm:ss"));
        ...
        //申請人資料列表-外澳接天宮
        public void GetStateContentlist_Jt(int AdminID, int ApplicantID, int kind, string Year)
        {
            LightDAC objLightDAC = new LightDAC(this);
            ...
            switch (kind)
            {
                case 1:
                    //點燈服務
                    dtData = objLightDAC.GetAPPCharge_Jt_Lights(ApplicantID, Year);
                    if (dtData.Rows.Count > 0)
                    {
                        OrderStateContent = OrderState("付款時間", DateTime.Parse(dtData.Rows[0]["ChargeDate"].ToString()).ToString("yyyy-MM-dd HH:mm:ss"));
                        ...
                        for (int i = 0; i < dtData.Rows.Count; i++)
                        {
                            ...
                            OrderInfo += OrderData("宮廟名稱", "外澳接天宮");
                            OrderInfo += OrderData("訂單編號", dtData.Rows[i]["Num2String"].ToString());
                            OrderInfo += OrderData("祈福人姓名", dtData.Rows[i]["Name"].ToString());
                            OrderInfo += OrderData("祈福人電話", dtData.Rows[i]["Mobile"].ToString());
                            OrderInfo += OrderData("農歷生日", dtData.Rows[i]["Birth"].ToString() + (dtData.Rows[i]["LeapMonth"].ToString() == "Y" ? " 閏月" : ""));
                    ...
                    //case 2:
                    //    //普度服務
                    //    dtData = objLightDAC.GetAPPCharge_Jt_Purdue(ApplicantID, Year);
                    //    if (dtData.Rows.Count > 0)
                    //    {
                    //        OrderStateContent = OrderState("付款時間", DateTime.Parse(dtData.Rows[0]["ChargeDate"].ToString()).ToString("yyyy-MM-dd HH:mm:ss"));
        ...
        //申請人資料列表-安平開台天后宮
        public void GetStateContentlist_Am(int AdminID, int ApplicantID, int kind, string Year)
        {
            LightDAC objLightDAC = new LightDAC(this);
            ...
            switch (kind)
            {
                case 1:
                    //點燈服務
                    dtData = objLightDAC.GetAPPCharge_Am_Lights(ApplicantID, Year);
                    if (dtData.Rows.Count > 0)
                    {
                        OrderStateContent = OrderState("付款時間", DateTime.Parse(dtData.Rows[0]["ChargeDate"].ToString()).ToString("yyyy-MM-dd HH:mm:ss"));
                        ...
                        for (int i = 0; i < dtData.Rows.Count; i++)
                        {
                            ...
                            OrderInfo += OrderData("宮廟名稱", "安平開台天后宮");
                            OrderInfo += OrderData("訂單編號", dtData.Rows[i]["Num2String"].ToString());
                            OrderInfo += OrderData("祈福人姓名", dtData.Rows[i]["Name"].ToString());
                            OrderInfo += OrderData("祈福人電話", dtData.Rows[i]["Mobile"].ToString());
                            OrderInfo += OrderData("農歷生日", dtData.Rows[i]["Birth"].ToString() + (dtData.Rows[i]["LeapMonth"].ToString() == "Y" ? " 閏月" : ""));
