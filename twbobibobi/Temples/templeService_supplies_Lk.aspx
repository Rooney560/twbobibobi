<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_supplies_Lk.aspx.cs" Inherits="twbobibobi.Temples.templeService_supplies_Lk" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="鹿港城隍廟|補財庫|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_supplies_Lk.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:site_name" content="鹿港城隍廟|補財庫|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/supplies_Lk.jpg?t=666168" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/supplies_Lk.jpg?t=666168" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/supplies_Lk.jpg?t=666168" />
    ...
    <title>鹿港城隍廟|補財庫|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
        ...
        <article id="Temple" class="page">
            ...
            <nav class="breadcrumb">
                ...
                <ul>
                    ...
                    <li><a href="https://bobibobi.tw/Temples/templeInfo.aspx?a=16" title="鹿港城隍廟">鹿港城隍廟</a></li>
                    <li>補財庫</li>
                </ul>
            </nav>
            ...
            <section>
                <div class="TempleImg">
                    <img src="https://bobibobi.tw/Temples/images/temple/supplies_Lk.jpg?t=666168" width="1160" height="550" alt="鹿港城隍廟補財庫" title="鹿港城隍廟補財庫" />
                </div>
                ...
                <div class="TempleServiceInfo">                    
                    <div class="EventServiceContent">
                        ...
                        <div class="EventServiceContent">
                        <div>
                            <h2>✨ 補財庫，旺財運！來鹿港城隍廟，讓財富源源不絕！ ✨</h2>
                            <p>你是否覺得最近財運不佳、收入停滯？或是努力許久仍無法累積財富？這時候，就是補財庫的最佳時機！鹿港城隍廟的補財庫儀式，讓您為財庫「加滿油」，迎接滿滿的好運與財富！</p>
                        </div>
                        <hr />
                        <div>
                            <h2>🎯 什麼是補財庫？</h2>
                            <p>補財庫是傳統信仰中非常重要的儀式，透過向財神與城隍爺祈求補足財庫缺漏，修復財富流通，幫助信眾扭轉財運、吸引財氣，為事業、投資和日常開支帶來更多保障。</p>
                        </div>
                        <hr />
                        <div>
                            <h2>🪙 補財庫的好處：</h2>
                            <p>
                                •	財運充盈：改善財務狀況，幫助收入穩定增長。<br />
                                •	事業順利：讓生意蒸蒸日上，機會源源不絕。<br />
                                •	家庭和諧：補財庫也象徵為全家增添福氣和財運。
                            </p>
                        </div>
                        <hr />
                        <div>
                            <h2>📍 鹿港城隍廟的特色補財庫儀式</h2>
                            <p>
                                •	專業指引：由廟方皇子老師指導，讓儀式更完整、效果更靈驗。<br />
                                •	全程貼心：補財庫儀式完成後，掛號寄給信眾黃金萬兩錢母及催財符令。<br />
                                •	城隍爺加持：鹿港城隍廟以靈驗聞名，求補財庫更是信徒心目中的首選。
                            </p>
                            <br />
                            <h1 class="TempleName">🪙 讓財庫充實，財運滾滾來！立即來鹿港城隍廟，感受財神與城隍爺的庇佑吧！</h1>
                        </div>
                        <div>
                            <h2>▌注意事項</h2>
                            <p style="color: red;">鹿港城隍廟管理委員會將於將於國曆四月十二日全天(8:00-17:00)舉行補財庫，
                                完成後會收到廟方補財庫的贈品(黃金萬兩錢母以及催財符令)。</p>
                        </div>
                        <div>
                            <h2>補財庫 $1600 /份 (含郵資$100)</h2>
                        </div>
                        </div>
...
<script>
    ...
    function gotoChecked_Lk() {
        ...
        AppSendback = "Y";
        Apprname_Tag = $("#bless_rec_name_1").val().trim();                                           //收件人姓名
        Apprmobile_Tag = $("#bless_rec_tel_1").val().trim();                                          //收件人電話
        ApprzipCode_Tag = $("#bless_rec_zipcode_1").val().trim();                                     //收件人郵政區號
        Apprcounty_Tag = $("select[name='bless_rec_county_1']").val().trim();                         //收件人縣市
        Apprdist_Tag = $("select[name='bless_rec_district_1']").val().trim();                         //收件人區域
        Appraddr_Tag = $("#bless_rec_address_1").val().trim();
        ...
        data = {
            ...
            Apprmobile_Tag: Apprmobile_Tag,
            ApprzipCode_Tag: ApprzipCode_Tag,
            Apprcounty_Tag: Apprcounty_Tag,
            Apprdist_Tag: Apprdist_Tag,
            Appraddr_Tag: Appraddr_Tag,
