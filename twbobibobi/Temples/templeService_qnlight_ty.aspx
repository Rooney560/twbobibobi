<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_qnlight_ty.aspx.cs" Inherits="twbobibobi.Temples.templeService_qnlight_ty" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="桃園威天宮|千手觀音千燈迎佛法會|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_qnlight_ty.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="保必保庇提供桃園威天宮千手觀音千燈迎佛法會線上報名服務" />
    <!--簡介-->
    <meta property="og:description" content="保必保庇提供桃園威天宮千手觀音千燈迎佛法會線上報名服務" />
    <!--簡介-->
    <meta property="og:site_name" content="桃園威天宮|千手觀音千燈迎佛法會|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/qnlight_ty_2025.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/qnlight_ty_2025.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/qnlight_ty_2025.jpg" />
    ...
    <title>桃園威天宮|千手觀音千燈迎佛法會|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/qnlight_ty_2025.jpg" width="1160" height="550" alt="保必保庇提供桃園威天宮２０２５千手觀音千燈迎佛法會" 
                        title="桃園威天宮２０２５千手觀音千燈迎佛法會" />
                </div>
                <h1 class="TempleName">歡迎使用《桃園威天宮》千手觀音千燈迎佛法會服務</h1>
                <div class="TempleServiceInfo">                    
                    <div class="EventServiceContent">
                        <div class="EventTime">
                            <div>活動開始日期：</div>
                        <div id="startTime">2025/10/14 00:00</div>
                            <br />
                            <div>活動截止日期：</div>
                        <div id="endTime">2025/11/04 23:59</div>
                        </div>
                        <div class="EventServiceContent">
                            <p>觀世音菩薩大慈大悲、照拂芸芸眾生。適逢觀世音菩薩出家紀念日期間，威天宮將於11月7日至11月8日(農曆9月18日至19日)，舉辨【千手觀音千燈迎佛祈福法會】。</p>
                            <p>一燈能破千年暗，慧光可度萬劫迷。點燈者，燃起心中菩提；迎佛者，開啟大願宏圖。</p>
                            <p>特別設置點燈功德項目，與特邀眾師父誦經加持功德迴向。敬邀大德報名點燈祈福，將點燈的功德迴向給自己與親人好友，得福德與善果報。</p>
                            <p>點燈期間：114年10月7日至11月30日</p>
                            <p>歡迎大德報名點燈祈福，為自身和親人好友祈福，做功德、結善緣，增加福報，阿彌陀佛～</p>

                            <br />
                            <h1 class="TempleName">功德項目</h1>
                            <br />
                            <h2>蓮花燈 / 600元</h2>
                            <p>蓮花象徵自性清淨不為世俗所染，是佛法中意喻【心靈清淨生智慧】的菩提之花。點蓮花燈，請 觀世音菩薩保祐您心中清明生智慧，照亮您的元辰。適用對象：個人</p>
                            <br />
                            <h2>八吉祥燈 / 1600元</h2>
                            <p>八吉祥燈是將佛教中常見、象徵佛法中圓滿、智慧和吉祥的「八寶」圖騰化，結合供燈功德的燈。點八吉祥燈請 觀世音菩薩保祐您脫離煩惱、增強正能量，賜予您祥和與喜悅。適用對象：個人</p>
                            <br />
                            <h2>闔家甘露燈 / 3600元</h2>
                            <p>甘露燈在佛教中象徵著照亮無明、開啟智慧，獲取世間與出世間的福德資糧。點甘露燈還能藉由供燈的功德為自己與家人們祈求平安健康、學業有成、事業順遂等世間福報。適用對象：個人、闔家或公司</p>
                            <br />
                            <h2>八吉祥花 / 600元</h2>
                            <p>八吉祥花代表佛教中八種具有吉祥意義的寶物：法輪、法螺、寶傘、寶蓋、蓮花、寶瓶、雙魚和盤長結（吉祥結），象徵佛陀的功德與佛法的圓滿。供八吉祥花能得佛法護佑免於苦惱，常得平安吉祥。適用對象：個人</p>
                        </div>
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput select">
                                    ...
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        ...
                                        <option value="蓮花燈">蓮花燈 / $600元</option>
                                        <option value="八吉祥燈">八吉祥燈 / $1600元</option>
                                        <option value="闔家甘露燈">闔家甘露燈 / $3600元</option>
                                        <option value="八吉祥花">八吉祥花 / $600元</option>
                                    </select>
                                </div>
                                <div class="FormInput text_s">
...
<script>
    ...
    $("#subBtn").on("click", function () {
        ...
        if (checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('桃園威天宮 2025千手觀音千燈迎佛法會活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('桃園威天宮 2025千手觀音千燈迎佛法會活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
        ...
        if (res.StatusCode == 1) {
            ...
            if (res.DataSource != null) {
                $.each(res.DataSource, function (i, item) {
                    ...
                    $("#bless_service_" + index).val(item.QnLightString);
    ...
    function gotoChecked_ty() {
        ...
        for (var i = 1; i <= listcount; i++) {
            ...
            QnLightString_Tag.push($("#bless_service_" + i).val().trim());                                  //服務項目
        }
        ...
        data = {
            ...
            QnLightString_Tag: JSON.stringify(QnLightString_Tag),
            listcount: listcount
        };
