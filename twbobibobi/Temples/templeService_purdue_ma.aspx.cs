    ...
    public partial class templeService_purdue_ma : AjaxBasePage
    {
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string postURL_Init = "Purdue_ma_Index";
                ...
                ApplicantID = objLightDAC.Addapplicantinfo_purdue_ma(
                    Name: AppName,
                    Mobile: AppMobile,
                    Cost: "0",
                    County: Appcounty,
                ...
                if (ApplicantID > 0)
                {
                    for (int i = 0; i < listcount; i++)
                    {
                        ...
                        string purdueString = PurdueType2String(purdueType, "23");
                        ...
                        int cost = GetPurdueCost(23, purdueType);

                        if (name != "")
                        {
                            purdueinfo = true;
                            PurdueID = objLightDAC.Addpurdue_ma(
