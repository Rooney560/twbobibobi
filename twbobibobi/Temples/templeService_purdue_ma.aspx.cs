...
{
    public partial class templeService_purdue_ma : AjaxBasePage
    {
        public int aid = 0;
        public int a = 0;
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string postURL = "Purdue_ma_Index";
                ...
                ApplicantID = objLightDAC.addapplicantinfo_purdue_ma(AppName, AppMobile, "0", "", "", "", "0", "N", "", "", 0, AdminID, postURL, Year);
                ...
                if (ApplicantID > 0)
                {
                    for (int i = 0; i < listcount; i++)
                    {
                        ...
                        {
                            purdueinfo = true;
                            PurdueID = objLightDAC.addpurdue_ma(ApplicantID, name, Jmobile[i].ToString(), Jsex[i].ToString(), Jpurduetype[i].ToString(), purdueString, "1", birth
            ...
            public void editinfo(BasePage basePage)
            {
                ...
                dtData = objLightDAC.Getpurdue_ma_info(applicantID, Year);
