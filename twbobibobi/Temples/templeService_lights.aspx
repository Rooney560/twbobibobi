<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_lights.aspx.cs" Inherits="twbobibobi.Temples.templeService_lights" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="現場祈福點燈|大甲鎮瀾宮|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    ...
    <!--簡介-->
    <meta property="og:site_name" content="現場祈福點燈|大甲鎮瀾宮|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    ...
    <title>現場祈福點燈|大甲鎮瀾宮|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="">
            ...
            <section>        
                <div class="TempleImg">
                    <img src="images/temple/lights_da.jpg" width="1160" height="550" alt="" />
                </div> 
                <h1 class="TempleName" style="text-align: center;">歡迎使用《大甲鎮瀾宮》點燈服務</h1>
                <!--訂購表單-->
                <!--說明：
                ...
                <div class="OrderForm">
                    <form>
                        ...
                        <div class="FormInput tel">
                            <label>購買人電話</label><input name="member_tel" type="tel" class="required" id="member_tel" placeholder="請輸入購買人聯絡電話"/>
                        </div>
                        ...
                        <ul class="InputGroup">
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormTitle_B">祈福人<span>（祈福人限填一位，每個點燈服務對應一位祈福人。如需多位，請點選增加祈福人。）</span></div>
