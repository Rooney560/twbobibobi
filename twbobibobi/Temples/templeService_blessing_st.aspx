<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_blessing_st.aspx.cs" Inherits="twbobibobi.Temples.templeService_blessing_st" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="松柏嶺受天宮|祈安植福|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_blessing_st.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="保必保庇提供松柏嶺受天宮祈安植福線上報名服務" />
    <!--簡介-->
    <meta property="og:description" content="保必保庇提供松柏嶺受天宮祈安植福線上報名服務" />
    <!--簡介-->
    <meta property="og:site_name" content="松柏嶺受天宮|祈安植福|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/blessing_st_2025.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/blessing_st_2025.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/blessing_st_2025.jpg" />
    ...
    <title>松柏嶺受天宮|祈安植福|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/blessing_st_2025.jpg?t=2589963" width="1160" height="550" alt="保必保庇提供松柏嶺受天宮祈安植福線上報名服務" 
                        title="保必保庇提供松柏嶺受天宮祈安植福線上報名服務" />
                </div>
                <h1 class="TempleName">歡迎使用《松柏嶺受天宮》祈安植福服務</h1>
                <div class="TempleServiceInfo">
                    ...
                    <div class="EventServiceContent">
                        ...
                        <br />
                        <h1 class="TempleName">祈安＝祈求平安</h1>
                        <p>「祈」是祈求、「安」是平安安定。</p>
                        <p>也就是向天上神明祈願，希望自身、家人、住家、事業能<span style="font-weight: bold;">平安順利、無災無厄。</span></p>
                        <h1 class="TempleName">植福＝種下福報</h1>
                        <p>「植」是栽種、「福」是福氣福德。</p>
                        <p>指透過善行（如誦經、供養、參與法會等），<span style="font-weight: bold;">累積善因善果、種下未來的福報與好運。</span></p>
                        <br />
                        <h2>總結一句話：</h2>
                        <br />
                        <h2>「祈安植福」就是祈求神明保佑平安、並透過修行與善行種下福報，讓人生順遂、遠離災禍。</h2>
                        <br />
                        <p>本宮於初一、十五、諸神聖誕日啟建道場，誦念《元始天尊說北方真武妙經》、《太上三元賜福赦罪解厄消災延生保命妙經》、《中天星主紫微寶懺》、《九天應元雷聲普化天尊玉樞寶經》等經懺，祈求合境平安，歡迎善信大德慶贊法會，下祈諸天高真鑑納，願以此功德消除現宿業，增長諸福慧，圓成勝善根，現眷咸安樂。</p>
                        <br />
                        <p>本宮為每一位報名者準備<span style="font-weight: bold;">一函專屬疏文、一份金紙，由道經團師姐逐一宣讀</span>，仰仗道力呈疏化財，祈求玄天上帝與合宮眾神鑑納賜福。</p>
...
<script>
    ...
    $("#subBtn").on("click", function () {
        ...
        if (location.search.indexOf('ad') >= 0 || checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('松柏嶺受天宮 2025祈安植福活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('松柏嶺受天宮 2025祈安植福活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
        ...
        if (res.StatusCode == 1) {
            ...
            if (res.DataSource != null) {
                $.each(res.DataSource, function (i, item) {
                    ...
                    $("#bless_service_" + index).val(item.BlessingString);
    ...
    function gotoChecked_st() {
        ...
        for (var i = 1; i <= listcount; i++) {
            ...
            BlessingString_Tag.push($("#bless_service_" + i).val().trim());                              //服務項目
        }
        ...
        data = {
            ...
            BlessingString_Tag: JSON.stringify(BlessingString_Tag),
            listcount: listcount
        };
