<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newsContent_2024purdue.aspx.cs" Inherits="Temple.Temples.newsContent_2024purdue" %>
...
<head runat="server">
    ...
    <meta property="og:title" content="２０２４中元普渡線上報名開始囉~|最新消息|【保必保庇】線上宮廟服務平台" />
    <!--標題-->
    ...
    <!--簡介-->
    <meta property="og:site_name" content="２０２４中元普渡線上報名開始囉~|最新消息|【保必保庇】線上宮廟服務平台" />
    <!--標題-->
    ...
    <title>２０２４中元普渡線上報名開始囉~|最新消息|【保必保庇】線上宮廟服務平台</title>
    <!--標題-->
...
<body>
    <div id="wrap">
        ...
        <article id="News" class="page">
            ...
            <section>
                <div class="NewsImg">
                    <img src="SiteFile/News/20240621_NewsImg.png" width="1160" height="550" alt="" /></div>
                <div class="NewsBk">
                    <h1>２０２４中元普渡線上報名開始囉~</h1>
                    <div class="NewsDate">發布日期：2024-06-21</div>
