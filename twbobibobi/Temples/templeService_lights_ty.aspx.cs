    ...
    public partial class templeService_lights_ty : AjaxBasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (objLightDAC.checkedLightsNum("8", adminID.ToString(), 1, 1, Year))
                {
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string postURL = "Lights_ty_Index";
                ...
                //string[] Lightstypelist = new string[] { "3", "4", "6", "8", "10", "11" };
                //for (int i = 0; i < 6; i++)
                //{
                ...
                {
                    if (objLightDAC.checkedLightsNum(GetLightsType(JLightsString_Tag[i].ToString(), "14"), AdminID.ToString(), count_ty_lights[i], -1, Year))
                    {
                        checkednum_ty = false;
                ...
                if (checkednum_ty)
                {
                    ApplicantID = objLightDAC.addapplicantinfo_lights_ty(AppName, AppMobile, "0", "", "", "", "0", "N", "", "", 0, AdminID, postURL, Year);
