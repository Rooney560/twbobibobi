<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_marriagelights_Luer.aspx.cs" Inherits="Temple.Temples.templeService_marriagelights_Luer" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_marriagelights_Luer.aspx" />
    <!--網址：請補上網址-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/marriagelights_Luer.png" width="1160" height="550" alt="" />
                </div>
                <h1 class="TempleName">台南正統鹿耳門聖母廟</h1>
                <div class="TempleServiceInfo">
                    <div class="EventTime">
                        <div>活動開始日期：</div>
                        <div>2023/11/01 00:00</div>
                        <br />
                        <div>活動截止日期：</div>
                        <div id="endTime">2023/11/30 23:59</div>
                    </div>
                    <div class="EventServiceContent">
                        <div>
                            <h2>點燈，還會收到來自「月老星君」的「良緣明信片」喔！
每一張明信片
都會先過爐加持，
再蓋上「愛的印章」，
從鹿耳門聖母廟的「愛情限時批」郵筒寄出，
將月老的祝福直接送到您的手上！</h2>
                        ...
                        <div class="TempleImg">
                            <img src="images/temple/0031.jpg" alt="" />
                        </div>    
                        <div>
                            <h2>▌月老姻緣殿</h2>
                            <p>若說起全台知名的月老廟，正統鹿耳門聖母廟的「月老星君」一定名列前茅，從「還願結婚照」就可以看出聖母廟月老超強神威！稱為「姻緣牆」的「愛情走廊」有綿延逾百公尺的婚紗照，全都是來還願的幸福新人，僅計算前來本廟遞送結婚照、登記還願的新人編號就已超過六萬對，可見「聖母廟月老」牽起的良緣已不可計數！</p>
                        </div>                      
                        <div>
                            <h2> 全台唯一「雷射雕刻七彩姻緣燈」</h2>
                            <p>絢爛奪目的燈牆可不是裝飾，而是全台首創的雷射雕刻姻緣燈！燈飾顏色可七彩變化、招來閃亮耀眼的好人緣，每盞燈還可以顯示點燈者的姓名，配合最新尋燈科技，只要用手機搜尋，即可看到自己的姻緣燈一閃一閃，超級吸睛、開運效果更加分！</p>
                        </div>
                        <div class="TempleImg">
                            <img src="images/temple/0029.jpg" alt="" />
                        </div>
                    </div>
                </div>
