<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_supplies_ty.aspx.cs" Inherits="Temple.Temples.templeService_supplies_ty" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="天赦日冬至招財補運活動|桃園威天宮|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_supplies_ty.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:site_name" content="天赦日冬至招財補運活動|桃園威天宮|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />
    <meta property="og:image" content="https://img.youtube.com/vi/6pvLjh11eo4/maxresdefault.jpg" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/supplies_ty_20251221.jpg?t=666168" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/supplies_ty_20251221.jpg?t=666168" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/supplies_ty_20251221.jpg?t=666168" />
    ...
    <meta name="twitter:title" content="桃園威天宮｜天赦日冬至招財補運 線上報名頁面" />
    <meta name="twitter:description" content="玉皇大帝赦罪補運大好時機！立即報名桃園威天宮補財活動，附加介紹影片說明流程，完成報名還能獲得好禮！" />
    <meta name="twitter:image" content="https://bobibobi.tw/Temples/images/temple/supplies_ty_20251221.jpg?t=666168" />

    <link rel="shortcut icon" href="images/favicon.png" />
    <link href="images/favicon.png" rel="apple-touch-icon" sizes="192x192" />


    <title>天赦日冬至招財補運活動|桃園威天宮|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="https://bobibobi.tw/Temples/images/temple/supplies_ty_20251221.jpg" width="1160" height="550" alt="桃園威天宮天赦日冬至招財補運" title="桃園威天宮天赦日冬至招財補運" />
                </div>
                <h1 class="TempleName">歡迎使用《桃園威天宮》冬至天赦日招財補運</h1>
                <div class="TempleServiceInfo">                    
                    <div class="EventServiceContent">
                        <div class="EventTime">
                            <div>活動開始日期：</div>
                        <div id="startTime">2025/10/27 00:00</div>
                            <br />
                            <div>活動截止日期：</div>
                            <div id="endTime">2025/12/18 11:00</div>
                        </div>
                        <div class="EventServiceContent">
                            <div>
                                <h2>天赦日是 玉皇大帝特赦開恩的日子。在天赦日當天祈福、轉運、補財庫都會特別的靈驗！今年的12月21日（農曆11月2日）不只是全家團圓的中秋節、月老星君的聖誕，還是難得的天赦日，想補運、增加貴人緣，讓桃花、財運都旺起來，那就不能錯過【冬至天赦日招財補運】！</h2>
                            </div>
                            <div>
                                <p>威天宮【天赦日招財補運】，請第十八代玉皇大帝 關聖帝君為您消災解厄、賜福補財庫！師父將在12月21日 (農曆11月2日)上午6:30的吉時為您在 關聖帝君座前供燈，上疏文稟告，將您的運勢補強轉正，讓您運晉財入、財源滾滾、闔家平安、好運旺旺來！早上的儀式將在威天宮臉書現場直播。</p>
                                <p>供燈時間：12月21日（星期日）至12月23日（星期二）</p>
                                <p>歡迎大德報名參加，讓您事業順利、財運旺旺旺</p>
                                <br />
                                <h2>招財補運 $1280元</h2>
                                <p>補運物品：三色石發財樹（好運至）、關公招財香火包、關公手機貼。
                                    <%--<a target="_blank" class="content_a" href="https://bobibobi.tw/Temples/images/temple/product/ty/product_supplies_ty.jpg">(看圖)</a>--%>
                                    <span id="supplies1" style="color:red" class="content_a" runat="server">(已額滿)</span></p>
                                <%--<h2>加強運勢升級版 $5880元</h2>
                                <p>補運物品：東菱玉發財樹（淨心靈）、關公招財香火包、關公手機貼，並加贈特別製作的【威天宮關公招財酒】！(請來威天宮領取)
                    ...
                    <form>
                        ...
                        <ul class="InputGroup">
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormTitle_B">祈福人<span>（祈福人限填一位，每個天赦日冬至招財補運對應一位祈福人。如需多位，請點選增加祈福人。）</span></div>
                                <div class="FormInput select">
                                    <label>活動項目</label>
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        <option value="4">招財補運 $1280</option>
...
<script>
    ...
    function validateBless(i) {
        ...
        if (!birth && !sbirth) {
            showToastAndFocus($li.find(".required2"), "請填寫國曆生日。");
            return false;
        }
    ...
    $("#subBtn").on("click", function () {
        ...
        if (checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('桃園威天宮 2025天赦日冬至招財補運已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('桃園威天宮 2025天赦日冬至招財補運尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
