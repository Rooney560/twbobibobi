<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_purdue_ma.aspx.cs" Inherits="Temple.Temples.templeService_purdue_ma" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="玉敕大樹朝天宮|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_purdue_ma.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:site_name" content="玉敕大樹朝天宮|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/purdue_ma_2025.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/purdue_ma_2025.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/purdue_ma_2025.jpg" />
    ...
    <title>玉敕大樹朝天宮|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/purdue_ma_2025.jpg" width="1160" height="550" alt="《玉敕大樹朝天宮》中元普渡線上報名" title="《玉敕大樹朝天宮》中元普渡線上報名" />
                </div>
                <h1 class="TempleName">歡迎使用《玉敕大樹朝天宮》中元普渡線上報名</h1>
                <div class="TempleServiceInfo">
                    <div class="EventTime">
                        ...
                        <br />
                        <div>活動截止日期：</div>
                        <div id="endTime">2025/08/25 23:59</div>
                    </div>
                    <div class="EventServiceContent">
                        <div>
                            <h2>何謂贊普</h2>
                            <p>贊普是贊助供養六道眾生齋食及法食的意思，不僅能施食供養，最主要是召請鬼道眾生來受法食，仗神佛的慈悲願力，讓一切餓鬼，皆能得度，成就無上功德。</p>
                            <p>報名參加【玉敕大樹朝天宮】代辦中元普渡服務。</p>
                            <p>即完成中元普渡，植福、轉好運！</p>
                            <p>普品貼上善信大德的姓名於農曆七月初八，擺在法會現場、宴請四方兄弟。</p>
                            <p>祭典後的祭品亦將送給低收入戶， 為參加祭典而未領回祭品者造功德與福報。</p>
                        </div>
                        <div>
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput select">
                                    ...
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        ...
                                        <option value="2">九玄七祖 $300</option>
                                        <option value="4">地基主 $300</option>
                                        <option value="6">嬰靈 $300</option>
                                        <option value="5">累世冤親債主 $300</option>
                                        <option value="7">三軍將士 $300</option>
                                        <option value="11">動物靈 $300</option>
                                    </select>
                                </div>
                                <div class="FormInput text_s">
                                ...
                                <div class="FormInput email mail">
                                    <label>Email</label><input name="bless_email_1" type="text" id="bless_email_1" placeholder="請輸入Email(選填)"/>
                                </div>
                                <div class="FormInput select">
                                    <label>祈福人地址</label>
    ...
    $("#subBtn").on("click", function () {
        ...
        if (checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('玉敕大樹朝天宮 2025普度活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('玉敕大樹朝天宮 2025普度活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
