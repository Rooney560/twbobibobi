...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="桃園威天宮|線上點燈|2025犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_lights_ty.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="保必保庇提供桃園威天宮安太歲 光明燈線上點燈，犯太歲生肖 蛇 豬 虎 猴" />
    <!--簡介-->
    <meta property="og:description" content="保必保庇提供桃園威天宮安太歲 光明燈線上點燈，犯太歲生肖 蛇 豬 虎 猴" />
    <!--簡介-->
    <meta property="og:site_name" content="桃園威天宮|線上點燈|2025犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/lights_ty_2025.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/lights_ty_2025.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/lights_ty_2025.jpg" />
    ...
    <title>桃園威天宮|線上點燈|2025犯太歲光明燈【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/lights_ty_2025.jpg" width="1160" height="550" alt="保必保庇提供桃園威天宮安太歲光明燈線上點燈，犯太歲生肖 蛇 豬 虎 猴" 
                        title="桃園威天宮線上點燈２０２５犯太歲光明燈" />
                </div>
                <h1 class="TempleName">歡迎使用《桃園威天宮》線上點燈服務</h1>
                <div class="TempleServiceInfo">                    
                    <div class="EventServiceContent">
                        <div>
                            <p>桃園威天宮 關聖帝君114年度(乙巳年)的點燈，已經開始報名。明年是蛇年，有屬蛇、豬、虎、猴的大德，明年是犯太歲、偏太歲，請記得點一盞太歲燈，讓您明年能逢凶化吉、一切平安順利！</p>
                        </div>
                        <div class="EventTime">
                            <div>活動開始日期：</div>
                        <div id="startTime">2024/11/01 00:00</div>
                            <br />
                            <div>活動截止日期：</div>
                        <div id="endTime">2025/10/17 23:59</div>
                        </div>
                        <div class="EventServiceContent">
                            <div>
                                <h2>光明燈 | 元辰光彩，照耀前途，費用300元。<span style="color:red;" class="content_a">(限量6000盞)</span><span id="light1" style="color:red" class="content_a" runat="server">(已額滿)</span></h2>
                            </div>
                            <div>
                                <h2>太歲燈 | 逢凶化吉，諸事順遂，費用300元。<span style="color:red;" class="content_a">(限量3000盞)</span><span id="light2" style="color:red" class="content_a" runat="server">(已額滿)</span></h2>
                            </div>
                            <div>
                                <h2>智慧燈 | 添增智慧 金榜題名，費用300元。<span style="color:red;" class="content_a">(限量3000盞)</span><span id="light7" style="color:red" class="content_a" runat="server">(已額滿)</span></h2>
                            </div>
                            <div>
                                <h2>財神燈 | 事業亨通，才庫豐盈，費用600元。<span style="color:red;" class="content_a">(限量3000盞)</span><span id="light3" style="color:red" class="content_a" runat="server">(已額滿)</span></h2>
                            </div>
                            <div>
                                <h2>藥師燈 | 消災解厄，病體康健，費用600元。<span style="color:red;" class="content_a">(限量300盞)</span><span id="light4" style="color:red" class="content_a" runat="server">(已額滿)</span></h2>
                            </div>
                            <div>
                                <h2>貴人燈 | 恩愛合和，天賜良緣，費用600元。<span style="color:red;" class="content_a">(限量1000盞)</span><span id="light5" style="color:red" class="content_a" runat="server">(已額滿)</span></h2>
                            </div>
                            <div>
                                <h2>福祿燈 | 身心健康，家庭和睦，費用600元。<span style="color:red;" class="content_a">(限量300盞)</span><span id="light6" style="color:red" class="content_a" runat="server">(已額滿)</span></h2>
                            </div>
