...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="台南正統鹿耳門聖母廟|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    ...
    <!--簡介-->
    <meta property="og:site_name" content="台南正統鹿耳門聖母廟|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/purdue_Luer_2025.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/purdue_Luer_2025.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/purdue_Luer_2025.jpg" />
    ...
    <title>台南正統鹿耳門聖母廟|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/purdue_Luer_2025.jpg" width="1160" height="550" alt="《台南正統鹿耳門聖母廟》中元普渡線上報名" title="《台南正統鹿耳門聖母廟》中元普渡線上報名" />
                </div>
                <h1 class="TempleName">歡迎使用《台南正統鹿耳門聖母廟》中元普渡線上報名</h1>
                <div class="TempleServiceInfo">
                    <div class="EventTime">
                        ...
                        <br />
                        <div>活動截止日期：</div>
                        <div id="endTime">2025/08/28 23:59</div>
                    </div>
                    <div class="EventServiceContent">
                        <div>
                            <h2>✨【鹿 耳 門 普  慶 讚 中 元】✨</h2>
                            <h2>🙏功德金1000元即可參與佈施植福🙏</h2>
                            <h2>💟普渡日期：農曆七月十五(國曆09/06)</h2>
                            <h2>⚜正統鹿耳門聖母廟⚜</h2>
    ...
    $("#subBtn").on("click", function () {
        ...
        if (location.search.indexOf('ad') >= 0 || checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('台南正統鹿耳門聖母廟 2025普度活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('台南正統鹿耳門聖母廟 2025普度活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
