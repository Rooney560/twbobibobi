...
{
    public partial class templeService_EmperorGuansheng_bobi_ty : AjaxBasePage
    {
        public int aid = 0;
        public int a = 0;
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string postURL = "EmperorGuansheng_ty_Index";
                ...
                //        basePage.mJSonHelper.AddContent("redirect", "templeCheck.aspx?kind=9&bobi=1&a=" + AdminID + "&aid=" + ApplicantID + (basePage.Request["ad"] != null ? "&ad=1" : "") + (basePage.Request["twm"] != null ? "&twm=1" : ""));
