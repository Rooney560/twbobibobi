    ...
    public partial class templeService_purdue_wjsan : AjaxBasePage
    {
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                ApplicantID = objLightDAC.Addapplicantinfo_purdue_wjsan(
                    Name: AppName,
                    Mobile: AppMobile,
                    Cost: "0",
                    County: Appcounty,
                ...
                if (ApplicantID > 0)
                {
                    for (int i = 0; i < listcount; i++)
                    {
                        ...
                        string purdueString = PurdueType2String(purdueType, "31");
                        ...
                        string firstname = Jfirstname[i].ToString();
                        string birthMonth = "0";
                        string age = "0";
                        ...
                        int cost = GetPurdueCost(31, purdueType);

                        if (name != "")
                        {
                            purdueinfo = true;
                            PurdueID = objLightDAC.Addpurdue_wjsan(
