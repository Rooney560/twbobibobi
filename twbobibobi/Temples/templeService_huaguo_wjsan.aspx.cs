...
namespace twbobibobi.Temples
{
    public partial class templeService_huaguo_wjsan : AjaxBasePage
    {
        public int aid = 0;
        public int a = 0;
        public string huaguolist = string.Empty;
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                if (checkednum_wjsan)
                {
                    ApplicantID = objLightDAC.addapplicantinfo_huaguo_wjsan(AppName, AppMobile, "0", Appcounty, Appdist, Appaddr, AppzipCode, "N", "", "", 0, AdminID, postURL, Year);
                    ...
                    if (ApplicantID > 0)
                    {
                        for (int i = 0; i < listcount; i++)
                        {
                            ...
                            {
                                huaguoinfo = true;
                                HuaguoID = objLightDAC.addHuaguo_wjsan(ApplicantID, name, mobile, sex, huaguoType, huaguoString,
                    ...
                    if (ApplicantID > 0 && huaguoinfo)
                    {
                        ...
                        basePage.mJSonHelper.AddContent("redirect",
                            ...
                            "kind=21&a=" + AdminID + "&aid=" + ApplicantID);
