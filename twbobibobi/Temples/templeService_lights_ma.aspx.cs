    ...
    public partial class templeService_lights_ma : AjaxBasePage
    {
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string postURL = "Lights_ma_Index";
                ...
                if (checkednum_ma)
                {
                    ApplicantID = objLightDAC.addapplicantinfo_lights_ma(AppName, AppMobile, "0", "", "", "", "0", "N", "", "", 0, AdminID, postURL, Year);
                    ...
                    if (ApplicantID > 0)
                    {
                        for (int i = 0; i < listcount; i++)
                        {
                            ...
                            {
                                lightsinfo = true;
                                LightsID = objLightDAC.addLights_ma(ApplicantID, name, mobile, sex, lightsType, lightsString,
