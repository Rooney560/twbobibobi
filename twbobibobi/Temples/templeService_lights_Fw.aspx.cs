    ...
    public partial class templeService_lights_Fw : AjaxBasePage
    {
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string postURL = "Lights_Fw_Index";
                ...
                if (ApplicantID > 0)
                {
                    for (int i = 0; i < listcount; i++)
                    {
                        ...
                        {
                            lightsinfo = true;
                            LightsID = objLightDAC.addLights_Fw(ApplicantID, name, mobile, sex, lightsType, lightsString,
                                "1", Birth, leapMonth, birthTime, birthMonth, age, Zodiac, sBirth, email, 1, addr, county, dist, zipCode, PetName, PetType, Year);
                        }
