...
namespace Temple.Temples
{
    public partial class templeService_purdue_wu : AjaxBasePage
    {
        public int aid = 0;
        public int a = 0;
        public string purduelist = string.Empty;
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string postURL_Init = "Purdue_wu_Index";
                ...
                ApplicantID = objLightDAC.Addapplicantinfo_purdue_wu(
                    Name: AppName, 
                    Mobile: AppMobile, 
                    Cost: "0",
                    County: Appcounty, 
                ...
                if (ApplicantID > 0)
                {
                    for (int i = 0; i < listcount; i++)
                    {
                        ...
                        string purdueString = PurdueType2String(purdueType, "6");
                        string homenum = Jhomenum[i].ToString();
                        ...
                        int cost = GetPurdueCost(6, purdueType);
                        int amount = int.TryParse(count, out amount) ? amount : 1;

                        if (name != "")
                        {
                            purdueinfo = true;
                            PurdueID = objLightDAC.Addpurdue_wu(
