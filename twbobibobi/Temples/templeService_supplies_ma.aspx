<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_supplies_ma.aspx.cs" Inherits="twbobibobi.Temples.templeService_supplies_ma" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="玉敕大樹朝天宮|天赦日招財補運|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_supplies_ma.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:site_name" content="玉敕大樹朝天宮|天赦日招財補運|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/supplies_ma.jpg?t=666168" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/supplies_ma.jpg?t=666168" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/supplies_ma.jpg?t=666168" />
    ...
    <title>玉敕大樹朝天宮|天赦日招財補運|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
        ...
        <article id="Temple" class="page">
            ...
            <nav class="breadcrumb">
                ...
                <ul>
                    ...
                    <li><a href="#" title="玉敕大樹朝天宮">玉敕大樹朝天宮</a></li>
                    <li>天赦日招財補運</li>
                </ul>
            </nav>
            ...
            <section>
                <div class="TempleImg">
                    <img src="https://bobibobi.tw/Temples/images/temple/supplies_ma.jpg?t=666168" width="1160" height="550" alt="玉敕大樹朝天宮天赦日招財補運" title="玉敕大樹朝天宮天赦日招財補運" />
                </div>
                <h1 class="TempleName">歡迎使用《高雄玉敕大樹朝天宮》天赦日招財補運活動</h1>
                <div class="TempleServiceInfo">                    
                    <div class="EventServiceContent">
                        <div class="EventTime">
                            <div>活動開始日期：</div>
                        <div id="startTime">2025/10/07 00:00</div>
                            <br />
                            <div>活動截止日期：</div>
                            <div id="endTime">2025/12/20 23:59</div>
                        </div>
                        <div class="EventServiceContent">
                        <div>
                            <h2>《天赦日是玉皇大帝開恩特赦的日子》</h2>
                        </div>
                        <hr />
                        <div>
                            <h2>【什麼是天赦日】</h2>
                            <p>《天寶曆》也記載，天赦是赦免過失、饒恕罪過的星辰，這天是玉皇大帝開恩特赦的日子，能疏獄洗冤、施恩恕罪，因此在天赦日拜拜能化解不好之事，
                                祈求諸事順遂據說會非常靈驗。</p>
                            <p>古書記載：「春赦戊寅，夏甲午，戊申赦日喜秋逢，三冬甲子甚為吉，百事遇禍反為福。」</p>
                        </div>
                        <hr />
                        <div>
                            <h2>【天赦日由來】</h2>
                            <p>天赦日是配合天干地支而產生，每年只有5～7天是天赦日。</p>
                            <p>據《天寶曆》所記：「天赦者，赦過宥罪之辰也，天之生育甲與戊，地之成立子、午、寅、申，故以甲戊配成天赦，其日可以緩刑獄，雪冤枉，施恩惠，
                                若與德神會合尤宜興造。」</p>
                            <p>以民俗來說，當有一些外病纏身，可能是前世的因果業障產生的，所以當有一些民俗上疾病纏身時，也會選擇在這天拜拜消業障。</p>
                        </div>
                        <hr />
                        <div>
                            <h2>【天赦日祈福】</h2>
                            <p>玉敕大樹朝天宮在天赦日這天，置香案虔誠地以疏文呈上稟奏向:<br />
                                「凌霄寶殿」玉皇上帝、三官大帝、南北斗星君、眾神佛，</p>
                            <p>懺悔並請求赦罪，祈求庇佑、消災解厄、祈安納福。祈求諸事順遂，開運補運，補財庫！</p>
                        </div>
                        <div>
                            <h2>誠聘：府城延陵道壇，高功道長：吳政憲道長 主法天赦日科儀</h2>
                            <h2>【114年乙巳蛇年天赦日日期】</h2>
                            <h2>國曆12月21日 (農曆冬月初二)</h2>
                ...
                <div class="OrderForm">
                    <form>
                        ...
                        <%--<div class="FormInput">
                            ...
                            <span style="color: red;">我們將根據購買人地址寄出發票，請填寫正確的購買人地址。</span>
                        </div>--%>
    ...
    $("#subBtn").on("click", function () {
        ...
        if (checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('玉敕大樹朝天宮 2025天赦日招財補運已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('玉敕大樹朝天宮 2025天赦日招財補運尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
