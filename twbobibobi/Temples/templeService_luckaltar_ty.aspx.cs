...
{
    public partial class templeService_luckaltar_ty : AjaxBasePage
    {
        public int aid = 0;
        public int a = 0;
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string LuckaltarString_Tag = basePage.Request["LuckaltarString_Tag"];                     //服務項目
                ...
                JArray JLuckaltarString_Tag = JArray.Parse(LuckaltarString_Tag);

                string postURL_Init = "Luckaltar_ty_Index";
                ...
                if (checkednum_ty)
                {
                    ...
                    ApplicantID = objLightDAC.Addapplicantinfo_luckaltar_ty(
                        AdminID,
                        AppName,
                        AppMobile,
                        "0",
                    ...
                    if (ApplicantID > 0)
                    {
                        for (int i = 0; i < listcount; i++)
                        {
                            ...
                            string luckaltarString = JLuckaltarString_Tag[i].ToString(); ;
                            string luckaltarType = GetLuckaltarType(luckaltarString, "14");
                            ...
                            {
                                luckaltarinfo = true;
                                LuckaltarID = objLightDAC.AddLuckaltar_ty(
                                    ...
                                    LuckaltarString: luckaltarString,
                                    Oversea: oversea,
                                    Birth: Birth,
                                    LeapMonth: leapMonth,
                                    BirthTime: birthTime,
                    ...
                    if (ApplicantID > 0 && luckaltarinfo)
                    {
            ...
            public void editinfo(BasePage basePage)
            {
                ...
                dtData = objLightDAC.Getluckaltar_ty_Info(applicantID, Year);
