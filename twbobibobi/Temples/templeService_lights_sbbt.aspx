<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_lights_sbbt.aspx.cs" Inherits="twbobibobi.Temples.templeService_lights_sbbt" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="花蓮慈惠石壁部堂|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_lights_sbbt.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="保必保庇提供花蓮慈惠石壁部堂安太歲 光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" />
    <!--簡介-->
    <meta property="og:description" content="保必保庇提供花蓮慈惠石壁部堂安太歲 光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" />
    <!--簡介-->
    <meta property="og:site_name" content="花蓮慈惠石壁部堂|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/lights_sbbt_2026.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/lights_sbbt_2026.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/lights_sbbt_2026.jpg" />
    ...
    <title>花蓮慈惠石壁部堂|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
        ...
        <article id="Temple" class="page">
            ...
            <nav class="breadcrumb">
                ...
                <ul>
                    ...
                    <li><a href="https://bobibobi.tw/Temples/templeInfo.aspx?a=39" title="花蓮慈惠石壁部堂">花蓮慈惠石壁部堂</a></li>
                    <li>祈福點燈</li>
                </ul>
            </nav>
            ...
            <section>
                <div class="TempleImg">
                    <img src="https://bobibobi.tw/Temples/images/temple/lights_sbbt_2026.jpg" width="1160" height="550" alt="保必保庇提供花蓮慈惠石壁部堂安太歲光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" 
                        title="花蓮慈惠石壁部堂線上點燈２０２６犯太歲光明燈" />
                </div>
                <h1 class="TempleName">歡迎使用《花蓮慈惠石壁部堂》線上點燈服務</h1>
                <div class="TempleServiceInfo">
                    ...
                    <div class="EventServiceContent">
                        ...
                        <br />
                        <div>
                            <p>花蓮慈惠堂石壁部堂，是花蓮地區信仰瑤池金母的重要道場之一。主祀「瑤池金母大天尊」。石壁部堂創立於民國五十四年（1965），由母娘降旨指示設立，在堂後山上，每晚出現數十蕊的紅火，所見者均覺奇怪，某一日，母娘娘指示此地是神仙集會之所堂址依山而建，為信眾心靈修持與祈福的聖地。</p>
                            <br />
                        ...
                        <table class="tablecontent">
                            ...
                            <tbody>
                                <tr>
                                    <td data-label="燈種名稱">光明燈(平安燈)</td>
                                    <td data-label="燈種介紹">祈求前途光明、平安吉祥、智慧增長。</td>
                                    <td data-label="燈種價格">$ 500</td>
                                    <td data-label="限量名額"> 1500 <br /><span id="light1" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">太歲燈</td>
                                    <td data-label="燈種介紹">為化解生肖與當年度值年太歲星君相沖、沖犯所產生的不利影響，祈求流年平安順遂、消災解厄、逢凶化吉。</td>
                                    <td data-label="燈種價格">$ 500</td>
                                    <td data-label="限量名額"> 1000 <br /><span id="light2" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">求子燈</td>
                                    <td data-label="燈種介紹">是對於渴望生育的夫婦，寄託著對子嗣的期盼和對家庭的渴望。</td>
                                    <td data-label="燈種價格">$ 500</td>
                                    <td data-label="限量名額"> 500 <br /><span id="light4" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">護子燈</td>
                                    <td data-label="燈種介紹">祈求保佑孕婦平安順產、護佑幼童平安健康。</td>
                                    <td data-label="燈種價格">$ 500</td>
                                    <td data-label="限量名額"> 500 <br /><span id="light5" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">文昌燈</td>
                                    <td data-label="燈種介紹">祈求學業進步、考試順利、金榜題名。</td>
                                    <td data-label="燈種價格">$ 500</td>
                                    <td data-label="限量名額"> 500 <br /><span id="light3" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">特別貴人燈</td>
                                    <td data-label="燈種介紹">祈求遇到良醫良藥，身體早日病癒。尚有如良師、益友、金主…等因緣的幫助，雪中送炭化險為夷。</td>
                                    <td data-label="燈種價格">$ 500</td>
                                    <td data-label="限量名額"> 500 <br /><span id="light6" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">特別健康燈</td>
                                    <td data-label="燈種介紹">求身體早日康復、平安健康。</td>
                                    <td data-label="燈種價格">$ 500</td>
                                    <td data-label="限量名額"> 500 <br /><span id="light7" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                                <tr>
                                    <td data-label="燈種名稱">特別事業燈</td>
                                    <td data-label="燈種介紹">祈求個人事業（包括工作、生意、職涯…等）能夠順利、穩定長久發展，並希望在人事、財務、研發等方面，有好的發展。</td>
                                    <td data-label="燈種價格">$ 500</td>
                                    <td data-label="限量名額"> 500 <br /><span id="light8" style="color:red;" class="content_a" runat="server">(已額滿)</span></td>
                                </tr>
                            </tbody>
                        </table>
                        <br />
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput select">
                                    ...
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        ...
                                        <option value="求子燈">求子燈 $500</option>
                                        <option value="護子燈">護子燈 $500</option>
                                        <option value="文昌燈">文昌燈 $500</option>
                                        <option value="特別貴人燈">特別貴人燈 $500</option>
                                        <option value="特別健康燈">特別健康燈 $500</option>
                                        <option value="特別事業燈">特別事業燈 $500</option>
                                    </select>
                                </div>
                                <div class="FormInput text_s">
    ...
    $("#subBtn").on("click", function () {
        ...
        if (checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('花蓮慈惠石壁部堂 2026點燈活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('花蓮慈惠石壁部堂 2026點燈活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
    ...
    function gotochecked(res) {
        ...
        if (res.StatusCode == 1) {
            ...
            if (res.overnumType == 3) {
                ...
                alert("太歲燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 5) {
                alert("文昌燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 44) {
                alert("求子燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 45) {
                alert("護子燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 10) {
                alert("特別貴人燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 8) {
                alert("特別健康燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 22) {
                alert("特別事業燈燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else {
