...
<head runat="server">
    ...
    <meta property="og:title" content="斗六五路財神宮|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_lights_Fw.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="保必保庇提供斗六五路財神宮安太歲 光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" />
    <!--簡介-->
    <meta property="og:description" content="保必保庇提供斗六五路財神宮安太歲 光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔" />
    <!--簡介-->
    <meta property="og:site_name" content="斗六五路財神宮|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/lights_Fw_2026.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/lights_Fw_2026.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/lights_Fw_2026.jpg" />
    ...
    <title>斗六五路財神宮|線上點燈|2026犯太歲光明燈【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/lights_Fw_2026.jpg" width="1160" height="550" alt="保必保庇提供斗六五路財神宮安太歲光明燈線上點燈，犯太歲生肖 馬 鼠 牛 兔"
                        title="斗六五路財神宮線上點燈２０２６犯太歲光明燈" />
                </div>
                ...
                <div class="TempleServiceInfo">
                    ...
                    <div class="EventServiceContent">
                        <div>
                            ...
                            <p>祈求  財庫飽滿、會賺錢不是師父、能守住財才是真功夫、錢財守不住、左手來、右手出、要如何守住財、一定要點財庫燈、由護法財神來幫您守住錢財。費用500元。
                        ...
                        <div>
                            ...
                            <p>祈求  彩卷、股市、娛樂八大行業、偏財運亨通、八方進財、財源滾滾而來、想要輕鬆進財、一定要點發財燈、由偏財神爺為您開啟偏財運。費用500元。
                        ...
                        <div>
                            ...
                            <p>祈求   增添桃花緣、異性緣、求取好人緣、穩定永固加深緣份、已婚者求婚姻圓滿 夫妻和諧恩愛、未婚者求賜好姻緣、戀愛中男女求賜感情穩定融合緣份永續，業務員 可增添桃花緣，業績節節上升。費用500元。
                        ...
                        <div>
                            ...
                            <p>祈求 貴人明現，斬除小三，化解小人與冤親債主，小人轉化為貴人，福星高照，命主光彩，費用500元。
                        ...
                        <div>
                            ...
                            <p>生肖 <span style="color: red;" class="content_a">馬｜(年沖)、鼠｜(對沖)、雞｜(偏沖)、兔｜(偏沖)</span>之信眾，因流年犯太歲，宜安奉太歲以保平安，費用500元
                        ...
                        <div>
                            ...
                            <p>
                                化解 冤親債主、消災解厄、延壽添福。生肖屬牛(犯死符)、虎(犯五鬼、官符)、龍(犯喪門、吊客)、羊(犯病符)、猴(犯天狗星)、狗(犯白虎星)宜安奉消災延壽燈，
                                以保平安。費用500元。
                        ...
                        <div>
                            ...
                            <p>五路財神宮 特別設立 [ 寵物平安燈 ] 為您的小寶貝祈福，讓牠能長久陪伴著您！費用500元。
                ...
                <div class="OrderForm">
                    <form>
                        ...
                        <ul class="InputGroup">
                            ...
                            <li bless-id="1">
                                <div class="DeletData">
                                    <a href="javascript:;" class="deletList" title="刪除">
                                        <img src="images/deletData.svg" alt="" /></a>
                                </div>
                                ...
                                <div class="FormInput text_s Pet" id="bless_pet_1">
                                    <div class="FormInput text_s">
                                        <label>寵物姓名</label><input name="bless_petname_1" type="text" class="petname required3" id="bless_petname_1" placeholder="請輸入寵物姓名" />
                                    </div>
                                    <div class="FormInput text_s">
                                        <label>寵物品種</label><input name="bless_pettype_1" type="text" class="pettype required3" id="bless_pettype_1" placeholder="請輸入寵物品種 (不知道請填無)" />
                                    </div>
                                </div>
                            </li>
    ...
    $(function () {
        ...
        $("#bless_service_1").change(function () {
            if ($(this).val() == "寵物平安燈") {
                ...
                $("#label_name_1").text("飼主姓名");
                $("#bless_name_1").attr("placeholder", "請輸入飼主姓名");

                $("#label_tel_1").text("飼主電話");
                $("#bless_tel_1").attr("placeholder", "請輸入飼主聯絡電話");

                $("#label_birth_1").text("飼主農曆生日");
                $("#label_sbirth_1").text("飼主國曆生日");
                $("#label_address_1").text("飼主地址");
                $("#bless_address_1").attr("placeholder", "請輸入飼主地址");
            }
            else {
                $("#bless_pet_1").hide();

                $("#label_name_1").text("祈福人姓名");
                $("#bless_name_1").attr("placeholder", "請輸入祈福人姓名");

                $("#label_tel_1").text("祈福人電話");
                $("#bless_tel_1").attr("placeholder", "請輸入祈福人聯絡電話");

                $("#label_birth_1").text("農曆生日");
                $("#label_sbirth_1").text("國曆生日");
                $("#label_address_1").text("地址");
...
<script>
    ...
    function validateBless(i) {
        ...
        // 點燈項目選寵物平安燈，寵物姓名及品種需填寫
        const ligthsString = $li.find(`#bless_service_${i}`).val()
        if (ligthsString === "寵物平安燈") {
            const petname = $li.find(`#bless_petname_${i}`).val();
            const pettype = $li.find(`#bless_pettype_${i}`).val();
            if (!petname && !pettype) {
                showToastAndFocus($li.find(".required3"), "請填入寵物姓名及品種。");
                return false;
            }
            clearError($li.find(".required3"));
        }
    ...
    $("#subBtn").on("click", function () {
        ...
        if (location.search.indexOf('ad') >= 0 || checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('斗六五路財神宮 2026點燈活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('斗六五路財神宮 2026點燈活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
    ...
    function gotochecked(res) {
        ...
        if (res.StatusCode == 1) {
            ...
            if (res.overnumType == 3) {
                alert("貴人燈 燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 4) {
                alert("安太歲 燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 6) {
                alert("發財燈 燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 7) {
                alert("月老桃花燈 燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 8) {
                alert("消災延壽燈 燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 12) {
                alert("寵物平安燈 燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else if (res.overnumType == 19) {
                alert("財庫燈 燈種已額滿，請重新填單。或至其他宮廟點燈。");
            }
            else {
