...
namespace twbobibobi.Temples
{
    ...
    /// 3. 處理購買人與祈福人資料寫入流程
    /// </remarks>
    public partial class templeService_blessing_st : AjaxBasePage
    {
        ...
        public class AjaxPageHandler
        {
            ...
            /// <summary> 祈福人編號 Blessing ID </summary>
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                string BlessingString_Tag = basePage.Request["BlessingString_Tag"];                 //服務項目
                ...
                JArray JBlessingString_Tag = JArray.Parse(BlessingString_Tag);

                string postURL_Init = "Blessing_st_Index";
                ...
                if (checkednum_st)
                {
                    ...
                    // === 建立購買人資料 ===
                    ApplicantID = objLightDAC.Addapplicantinfo_blessing_st(
                        Name: AppName,
                        Mobile: AppMobile,
                        Cost: "0",
                        County: Appcounty,
                    ...
                    if (ApplicantID > 0)
                    {
                        for (int i = 0; i < listcount; i++)
                        {
                            ...
                            string blessingString = JBlessingString_Tag[i].ToString();
                            string blessingType = GetBlessingType(blessingString, "35");
                            ...
                            {
                                blessinginfo = true;
                                BlessingID = objLightDAC.AddBlessing_st(
            ...
            public void editinfo(BasePage basePage)
            {
                ...
                dtData = objLightDAC.Getblessing_st_Info(applicantID, Year);
