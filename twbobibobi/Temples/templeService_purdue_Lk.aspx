...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="鹿港城隍廟|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    ...
    <!--簡介-->
    <meta property="og:site_name" content="鹿港城隍廟|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/purdue_Lk_2025.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/purdue_Lk_2025.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/purdue_Lk_2025.jpg" />
    ...
    <title>鹿港城隍廟|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/purdue_Lk_2025.jpg" width="1160" height="550" alt="《鹿港城隍廟》中元普渡線上報名" title="《鹿港城隍廟》中元普渡線上報名" />
                </div>
                <h1 class="TempleName">歡迎使用《鹿港城隍廟》中元普渡線上報名</h1>
                <div class="TempleServiceInfo">
                    <div class="EventTime">
                        ...
                        <br />
                        <div>活動截止日期：</div>
                        <div id="endTime">2025/08/21 23:59</div>
                    </div>
                    <div class="EventServiceContent">
                        <div>
                            <h2>鹿港普渡歌，整個農曆七月份，鎮內每天都有普渡~</h2>
                            <p>初一放水燈......初五城隍廟...</p>
                            <p>城隍廟的普渡是在農曆七月初五(國曆9/6)星期六，</p>
                            <p>很多信眾都誤以為在農曆十五，</p>
                            <p>等到普渡法會辦完了才來登記... </p>
    ...
    $("#subBtn").on("click", function () {
        ...
        if (location.search.indexOf('ad') >= 0 || checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('鹿港城隍廟 2025普度活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('鹿港城隍廟 2025普度活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
