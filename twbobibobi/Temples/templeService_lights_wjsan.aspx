...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="祈福點燈|台灣道教總廟無極三清總道院|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    ...
    <meta property="og:description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。
        ...
        福壽燈,虎爺燈,補財庫,蛇年點燈,114年點燈,2025點燈,新春點燈,錢母,發財金" />
    <!--簡介-->
    <meta property="og:site_name" content="祈福點燈|台灣道教總廟無極三清總道院|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    ...
    <title>祈福點燈|台灣道教總廟無極三清總道院|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/lights_wjsan_2025.jpg?t=2589963" width="1160" height="550" alt="" />
                </div>
                ...
                <div class="TempleServiceInfo">
                    <div class="EventTime">
                        ...
                        <br />
                        <div>活動截止日期：</div>
                        <div id="endTime">2025/03/15 23:59</div>
                    </div>
                    <div class="EventServiceContent">
                        ...
                        <div id="lights_an" runat="server">
                            ...
                            <br />
                            <h1 class="TempleName">財神斗 $3000</h1>
                            <h1 class="TempleName">事業斗 $3000</h1>
                            <h1 class="TempleName">平安斗 $3000</h1>
                            <h1 class="TempleName">文昌斗 $3000</h1>
                            <h1 class="TempleName">藥師斗 $3000</h1>
                            <h1 class="TempleName">元神斗 $3000</h1>
                            <h1 class="TempleName">福祿壽斗 $3000</h1>
                            <h1 class="TempleName">觀音斗 $3000</h1>
                        </div>
                    </div>
                </div>
