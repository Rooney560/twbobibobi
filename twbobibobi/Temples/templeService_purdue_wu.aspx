<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_purdue_wu.aspx.cs" Inherits="Temple.Temples.templeService_purdue_wu" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="北港武德宮|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_purdue_wu.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:site_name" content="北港武德宮|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/purdue_wu_2025.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/purdue_wu_2025.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/purdue_wu_2025.jpg" />
    ...
    <title>北港武德宮|中元普度|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/purdue_wu_2025.jpg" width="1160" height="550" alt="《北港武德宮》中元普渡線上報" title="《北港武德宮》中元普渡線上報" />
                </div>
                <h1 class="TempleName">歡迎使用《北港武德宮》中元普渡線上報名</h1>
                <div class="TempleServiceInfo">
                    <div class="EventTime">
                        ...
                        <br />
                        <div>活動截止日期：</div>
                        <div id="endTime">2025/08/23 23:59</div>
                    </div>
                    <div class="EventServiceContent">
                        <div>
                            <h2>歲次癸卯年北港武德宮中元普度</h2>
                            <p>普度即是讓大千世界的每個人得到照護的方式，為別人植福亦可使自己獲褔，亦使幽陽兩界皆得平安與福氣!!</p>
                            <p>報名參加【北港武德宮】代辦中元普渡服務。</p>
                            <p>歡迎十方善信前來贊普，每份普品1500元，由本宮透過慈善團體捐出。</p>
                        </div>
                        <div>
                            <h2>▌降文開示</h2>
                            <p>中天勝宰冥陽利</p>
                    ...
                    <form>
                        ...
                        <ul class="InputGroup">
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput tel">
                                    <label>祈福人市話</label><input name="bless_homenum_1" type="tel" class="" id="bless_homenum_1" placeholder="請輸入市話(選填)"/>
                                </div>
                                <div class="FormInput email mail">
                                    <label>祈福人信箱</label><input name="bless_email_1" type="text" class="" id="bless_email_1" placeholder="請輸入Email(選填)"/>
                                </div>
                                <div class="FormInput select">
                                    <label>祈福人地址</label>
    ...
    $("#subBtn").on("click", function () {
        ...
        if (checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('北港武德宮 2025普度活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('北港武德宮 2025普度活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
