<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_marriagelights_Luer_twm.aspx.cs" Inherits="Temple.Temples.templeService_marriagelights_Luer_twm" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="月老姻緣燈|台南正統鹿耳門聖母廟|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_marriagelights_Luer_twm.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:description" content="世代信仰，數位傳承 - 與全臺知名宮廟合作，提供宮廟服務線上報名，讓您在忙碌之餘也可以透過線上報名的方式,參與宮廟的服務。" />
    <!--簡介-->
    <meta property="og:site_name" content="月老姻緣燈|台南正統鹿耳門聖母廟|合作宮廟|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    ...
    <title>月老姻緣燈|台南正統鹿耳門聖母廟|合作宮廟|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
                ...
                <div class="TempleServiceInfo">
                    <div class="EventServiceContent">
                        <div style="text-align: center;">
                            <img src="images/temple/coollogo_com-316181184.png" alt="" />
                            <img src="images/temple/coollogo_com-7262113.png" alt="" />
                        </div>    
                        <br /> 
                        <div>
                            <h2>💑月老降臨~讓愛情之花在你們心中綻放，姻緣順利來臨！</h2>
                            <p>在愛情的天空中，我們都期待著一道神奇的光芒，照亮我們的心靈，指引我們找到愛情的彼岸。月老降臨，為你帶來愛情的祝福和祈福，讓你的姻緣之路更加順利，愛情不再遙遠，幸福即將來臨！不只幫自己點，還可以幫你的另一伴點燈~雙雙對對 幸福永遠</p>
                        </div>                      
                        <div>
                            <h2>💖月老姻緣燈：</h2>
                            <p>為你和心愛的人點燃神聖的燈火，祈求月老的庇佑和祝福，讓愛情之花綻放。全台首創的雷射雕刻姻緣燈！燈飾顏色可七彩變化、招來閃亮耀眼的好人緣，還可以顯示點燈者的姓名，配合最新尋燈科技，用手機搜尋，即可看到自己的姻緣燈一閃一閃，開運效果更加分！</p>
                        </div>
                        <div class="TempleImg">
                            <img src="images/temple/marriagelights_0001.png" alt="" />
                        </div>
                        <div>
                            <h2>💖個性化祝福：</h2>
                            <p>寫下你最真摯的祝福，讓愛情之光永遠照耀你們的心靈。(12字以內會show在燈上）</p>
                        </div>
                        <div>
                            <h2>💌愛情明信片：</h2>
                            <p>點燈，還會收到來自「月老星君」的「良緣明信片」喔！ 每一張明信片都會先過爐加持，再蓋上「愛的印章」，從鹿耳門聖母廟的「愛情限時批」郵筒寄出，將月老的祝福直接送到您的手上！</p>
                        </div>
                        <div class="TempleImg">
                            <img src="images/temple/0030.jpg" alt="" />
                        </div>    
                        <div class="TempleImg">
                            <img src="images/temple/marriagelights_0002.png" alt="" />
                        </div>
                        <div>
                            <h2>💌雙人點燈幸福加倍：</h2>
                            <p>夫妻、情侶一起點燈，在月老的庇佑與祝福之下，感情可以節節升溫與順遂，在新的一年裡，來替自己與心愛的另一半點一盞月老姻緣燈。</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form>
                        ...
                        <ul class="InputGroup">
                            ...
                            <li bless-id="1">
                                ...
                                <div class="FormInput text_s">
                                    <label>祈福小語</label><input name="bless_msg_1" type="text" class="required" id="bless_msg_1" maxlength="12" placeholder="請輸入祈福小語(12字內 會秀在燈上)"/>
                                </div>
                            </li>
...
<script>
    ...
    function gotoChecked_Luer() {
        ...
        for (var i = 1; i <= listcount; i++) {
            ...
            msg_Tag.push($("#bless_msg_" + i).val());                                           //祈福小語
        }
        ...
        data = {
            ...
            msg_Tag: JSON.stringify(msg_Tag),
            listcount: listcount
        };
