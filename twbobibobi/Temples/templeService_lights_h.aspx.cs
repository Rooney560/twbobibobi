    ...
    public partial class templeService_lights_h : AjaxBasePage
    {
        ...
        public class AjaxPageHandler
        {
            ...
            public void gotochecked(BasePage basePage)
            {
                ...
                postURL += basePage.Request["fbh"] != null ? "_FBH" : "";
                ...
                postURL += basePage.Request["inh"] != null ? "_INH" : "";

                postURL += basePage.Request["elv"] != null ? "_ELV" : "";

                ApplicantID = objLightDAC.addapplicantinfo_lights_h(AppName, AppMobile, "0", "", "", "", "0", "N", "", "", 0, AdminID, postURL, Year);
                ...
                if (ApplicantID > 0)
                {
                    for (int i = 0; i < listcount; i++)
                    {
                        ...
                        {
                            lightsinfo = true;
                            LightsID = objLightDAC.addLights_h(ApplicantID, name, mobile, sex, lightsType, lightsString,
