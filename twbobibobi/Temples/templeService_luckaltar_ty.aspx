<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="templeService_luckaltar_ty.aspx.cs" Inherits="twbobibobi.Temples.templeService_luckaltar_ty" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <meta property="og:title" content="桃園威天宮|新春賀歲感恩招財祿位|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:url" content="https://bobibobi.tw/Temples/templeService_luckaltar_ty.aspx" />
    <!--網址：請補上網址-->
    <meta name="description" content="保必保庇提供桃園威天宮新春賀歲感恩招財祿位線上報名服務" />
    <!--簡介-->
    <meta property="og:description" content="保必保庇提供桃園威天宮新春賀歲感恩招財祿位線上報名服務" />
    <!--簡介-->
    <meta property="og:site_name" content="桃園威天宮|新春賀歲感恩招財祿位|【保必保庇】線上宮廟服務平臺" />
    <!--標題-->
    <meta property="og:type" content="website" />

    <!--抓取圖片-->
    <meta property="og:image" content="https://bobibobi.tw/Temples/images/temple/luckaltar_ty_2025.jpg" />
    <meta name="twitter:image:src" content="https://bobibobi.tw/Temples/images/temple/luckaltar_ty_2025.jpg" />
    <link rel="image_src" href="https://bobibobi.tw/Temples/images/temple/luckaltar_ty_2025.jpg" />
    ...
    <title>桃園威天宮|新春賀歲感恩招財祿位|【保必保庇】線上宮廟服務平臺</title>
    <!--標題-->
...
<body>
    ...
    <div id="wrap">
        ...
        <article id="Temple" class="page">
            ...
            <section>
                <div class="TempleImg">
                    <img src="images/temple/luckaltar_ty_2025.jpg" width="1160" height="550" alt="保必保庇提供桃園威天宮２０２５新春賀歲感恩招財祿位" 
                        title="桃園威天宮２０２５新春賀歲感恩招財祿位" />
                </div>
                <h1 class="TempleName">歡迎使用《桃園威天宮》新春賀歲感恩招財祿位服務</h1>
                <div class="TempleServiceInfo">                    
                    <div class="EventServiceContent">
                        <div class="EventTime">
                            <div>活動開始日期：</div>
                        <div id="startTime">2025/12/15 00:00</div>
                            <br />
                            <div>活動截止日期：</div>
                        <div id="endTime">2026/02/19 23:59</div>
                        </div>
                        <div class="EventServiceContent">
                            <p>威天宮農曆新年期間熱鬧推出【新春賀歲招財抽獎活動】，誠邀善信大德來立【新春感恩招財祿位】，向 關聖帝君恭賀新年好。立祿位有如拿到福運金鑰，開啟好運之門，恭請 帝君降臨神威護祐，加持您與家人全年平安順遂、事業飛黃騰達！</p>
                            <br />
                            <p>每位立祿位善信皆贈摸彩券！115年3月1日下午4點，威天宮大殿直播摸獎，頭獎【純金999帝君聖牌】金光閃閃、二獎【IPHONE17 Pro】科技旺運、三獎【純金關公墜子】福氣加持，還有超多獎品等您中大獎！</p>
                            <br />
                            <p>敬邀大德立祿位，恭請 帝君保平安、招財進寶，開啟紅紅火火新的一年！</p>
                            <br />
                            <h1 class="TempleName">威天宮官網報名的大德，請於115年2月22日（星期日）下午4點前來威天宮領取贈品和摸彩劵，逾期未領視同放棄摸獎權利。</h1>
                            <br />
                            <h1 class="TempleName">【新春賀歲感恩招財祿位】</h1>
                            <br />
                            <h2>1.祿位名稱&結緣金</h2>
                            <br />
                            <h2>【吉祥招財祿位】 / 結緣金NT 1,000元</h2>
                            <p>吉祥平安、喜氣滿堂，闔家平安幸福！</p>
                            <p>立吉祥祿位贈「立馬招財鑰匙圈」(隨機贈送，恕不挑色)</p>
                            <p>天天好運爆棚、諸事順遂！</p>
                            <p>【請於115年2月22日(星期日)下午4點前來威天宮領取贈品和摸彩劵。】</p>
                            <br />
                            <h2>【如意招財祿位】 / 結緣金:3600元 贈送一指定江山水晶球+贈摸彩券</h2>
                            <p>心想事成、萬事亨通！</p>
                            <p>立如意祿位送贈「一指定江山水晶球」</p>
                            <p>稱心遂願、財源廣進、喜上眉梢！</p>
                            <p>【請於115年2月22日(星期日)下午4點前來威天宮領取贈品和摸彩劵。】</p>
                            <br />
                            <h2>2. 抽獎活動</h2>
                            <p>新春感恩招財祿位日期:114/12/06（週六)～115/03/01(日) </p>
                            <p>(1) 報名活動截止時間：115/03/01(日)下午12:00🕞截止。</p>
                            <p>(2) 抽獎日期:115/03/01(日)下午16:00點現場直播抽獎</p>
                            <p>   🔴中獎者名單公布桃園威天宮臉書及現場公告欄。</p>
                            <br />
                            <h2>3. 中獎獎品</h2>
                            <p>    1.純金999帝君聖牌*1名</p>
                            <p>    2.IPHONE17 Pro*5名</p>
                            <p>    3.純金關公墜子*10名</p>
                            <p>    4.獎金:8800元*15名</p>
                            <p>    5.帝君招財酒*15名</p>
                            <p>    6.帝君聖印*20名</p>
                            ...
                            <p>    10.泡麵碗*120名</p>
                            <br />
                            <p>各獎項得獎者須2026/04/06(一)前憑存根聯單據領獎，請攜帶身分證或其他證件核對資料，存根聯遺失、逾期未領、不符合桃園威天宮相關活動規範…等視為放棄領獎權利，恕無法要求補發、不另行通知，亦不補抽，桃園威天宮保留隨時修正、暫停、終止或解釋本活動之最終權利，並以本活動公告為準。</p>
                        </div>
                    ...
                    <form>
                        ...
                        <ul class="InputGroup">
                            ...
                            <li bless-id="1">
                                ...
                                <div>（祈福人限填一位，每種活動項目對應一位祈福人。如需多位，請點選增加祈福人。）</div>
                                <div class="FormInput select">
                                    <label>活動項目</label>
                                    <select name="bless_service_1" class="required" id="bless_service_1">
                                        <option value>請選擇</option>
                                        <option value="吉祥招財祿位">吉祥招財祿位 / $1000元</option>
                                        <option value="如意招財祿位">如意招財祿位 / $3600元</option>
                                    </select>
                                </div>
                                <div class="FormInput text_s">
                                ...
                                <div class="FormInput date">
                                    <label>國曆生日</label><input name="bless_sbirth_1" type="text" class="datapicker required2" id="bless_sbirth_1" placeholder="請選擇國曆生日" />
                                </div>
                                <div class="FormInput select">
                                    <label>祈福人地址</label>
...
<script>
    ...
    function validateBless(i) {
        ...
        if (!birth && !sbirth) {
            showToastAndFocus($li.find(".required2"), "請選擇國曆生日。");
            return false;
        }
    ...
    $("#subBtn").on("click", function () {
        ...
        if (checkedStartTime()) {
            if (checkEndTime()) {
                ...
                alert('桃園威天宮 2025新春賀歲感恩招財祿位活動已截止！');
                location = 'https://bobibobi.tw/Temples/temple.aspx';
            }
        } else {
            alert('桃園威天宮 2025新春賀歲感恩招財祿位活動尚未開始！');
            location = 'https://bobibobi.tw/Temples/temple.aspx';
        }
    })
        ...
        if (res.StatusCode == 1) {
            ...
            if (res.DataSource != null) {
                $.each(res.DataSource, function (i, item) {
                    ...
                    $("#bless_service_" + index).val(item.LuckaltarString);
    ...
    function gotoChecked_ty() {
        ...
        for (var i = 1; i <= listcount; i++) {
            ...
            LuckaltarString_Tag.push($("#bless_service_" + i).val().trim());                                  //服務項目
        }
        ...
        data = {
            ...
            LuckaltarString_Tag: JSON.stringify(LuckaltarString_Tag),
            listcount: listcount
        };
