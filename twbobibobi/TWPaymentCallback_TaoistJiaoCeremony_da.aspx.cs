...
{
    public partial class TWPaymentCallback_TaoistJiaoCeremony_da : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Request["uid"] != null && Request["oid"] != null && Request["tid"] != null && Request["mac"] != null)
            {
                ...
                {
                    string rebackURL = "https://bobibobi.tw/Temples/templeService_TaoistJiaoCeremony_da.aspx";

                    if (dtCharge.Rows[0]["PayChannelLog"].ToString().IndexOf("bobi") > 0)
                    {
                        rebackURL = "https://bobibobi.tw/Temples/templeService_TaoistJiaoCeremony_bobi_da.aspx";
                    }
                    ...
                    if (status == 0)
                    {
                        ...
                        if (result[0] == "1" || result[0] == "2")
                        {
                            ...
                            if (objDatabaseHelper.UpdateChargeLog_TaoistJiaoCeremony_da(orderId, tid, msg, Request.UserHostAddress, CallbackLog, Year, ref ChargeType))
                            {
                                ...
                                {
                                    m2 = "https://bobibobi.tw/Temples/templeComplete.aspx?a=" + adminID + "&aid=" + aid + "&kind=13" + 
                    ...
                    {
                        //已經付費成功。
                        m2 = "https://bobibobi.tw/Temples/templeComplete.aspx?kind=13&a=" + adminID + "&aid=" + aid + 
                            (dtCharge.Rows[0]["ChargeType"].ToString() == "Twm" ? "&twm=1" : "");
                        Response.Redirect(m2, true);
                    }
                    else
