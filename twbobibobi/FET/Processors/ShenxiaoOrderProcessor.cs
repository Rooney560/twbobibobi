...
{
    public class ShenxiaoOrderProcessor : TempleOrderProcessorBase
    {
        private readonly int _adminID = 33;
        private string PostUrl = "_sx_Index_FETAPI";

        public ShenxiaoOrderProcessor(
            BasePage page,
            string year)
            : base(page, year)
        {
        ...
        /// 處理神霄玉府財神會館訂單
        /// </summary>
        /// <param name="purchaser">購買人資料</param>
            ...
            string OrderId)
        {
            ...
            switch (kind)
            {
                ...
                case "1":
                    ...
                    //// 新增購買人資料
                    //int applicantId = _lightDAC.addapplicantinfo_lights_sx(
                    ...
                    //resultOrderNumbers.AddRange(ProcessLighting(applicantId, applicant, prayedPersons, Tid, fetOrderNumber, amount, itemsJson, dtNow));
                    break;
                // 普度
                case "2":
                    ...
                    //// 新增購買人資料
                    //applicantId = _lightDAC.addapplicantinfo_purdue_sx(
                    //    Name: applicant.appName,
                    //    Mobile: applicant.appMobile,
                    //    Cost: totalAmount,
                    //    County: applicant.appCity,
                                             ...
                                             DateTime dtNow)
        {
            ...
            //    // 呼叫 LightDAC
            //    int lightsId = _lightDAC.addLights_sx(
            ...
            //_dbHelper.AddChargeLog_Lights_sx(
            //    OrderID: orderID,
            //    ApplicantID: applicantId,
            //    Amount: totalAmount,
            //    ChargeType: "FETAPI",
            ...
            //// 更新並獲取燈號
            //DataTable dtCharge = _dbHelper.GetChargeLog_Lights_sx(orderID, _year);
            ...
            //    //更新流水付費表資訊(付費成功)
            //    if (!_dbHelper.UpdateChargeLog_Lights_sx(
            //        orderID,
            //        Tid,
            //        msg,
                                             ...
                                             DateTime dtNow)
        {
            ...
            foreach (var p in prayedPersons)
            {
                ...
                // 呼叫 LightDAC
                //int purdueId = _lightDAC.addpurdue_sx(
                //    applicantID: applicantId,
                //    Name: p.Name,
                //    Mobile: mobile,
                //    Sex: gender,
