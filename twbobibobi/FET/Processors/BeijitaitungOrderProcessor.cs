...
{
    /// <summary>
    /// Class: BeijitaitungOrderProcessor
    /// 實作 ITempleOrderProcessor，池上北極玄天宮點燈建單邏輯
    /// </summary>
    public class BeijitaitungOrderProcessor : TempleOrderProcessorBase
    {
        private readonly int _adminID = 38;
        private string PostUrl = "_bj_Index_FETAPI";
        ...
        public BeijitaitungOrderProcessor(
            BasePage page,
            string year)
            : base(page, year)
        {
            ...
            string OrderId)
        {
            ...
            if (page != null)
            {
                page.SaveTimingLog("進入 BeijitaitungOrderProcessor.HandleOrderAsync", 0);
            }
            ...
            switch (kind)
            {
                ...
                case "1":
                    ...
                    // 新增購買人資料
                    int applicantId = _lightDAC.Addapplicantinfo_lights_bj(
                                             ...
                                             DateTime dtNow)
        {
            ...
            foreach (var p in prayedPersons)
            {
                ...
                // 呼叫 LightDAC
                int lightsId = _lightDAC.AddLights_bj(
            ...
            _lightDAC.AddChargeLog_Lights_bj(
                OrderID: OrderId,
                ApplicantID: applicantId,
                Amount: totalAmount,
                ChargeType: "FETAPI",
            ...
            if (dtCharge != null && dtCharge.Rows.Count > 0 && Convert.ToInt32(dtCharge.Rows[0]["Status"]) == 0)
            {
                ...
                int uStatus = 0;
                //更新流水付費表資訊(付費成功)
                if (!_lightDAC.UpdateChargeLog_Lights_bj(
                    OrderId,
                    Tid,
                    msg,
