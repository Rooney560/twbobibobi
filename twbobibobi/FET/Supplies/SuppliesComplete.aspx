<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SuppliesComplete.aspx.cs" Inherits="Temple.FET.Supplies.SuppliesComplete" %>
...
<script>
    ...
    $("#BackHome").on("click", function () {
        window.location = 'https://bobibobi.tw/FET/Supplies/SuppliesIndex.aspx';
        //window.location = 'https://localhost:44329/FET/Supplies/SuppliesIndex.aspx';
    });
</script>
</body>
</html>
