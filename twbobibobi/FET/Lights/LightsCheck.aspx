<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LightsCheck.aspx.cs" Inherits="Temple.FET.Lights.LightsCheck" %>
        ...
        switch (url.searchParams.get('kind')) {
            case "1":
                switch (url.searchParams.get('a')) {
                    case "10":
                        window.location = 'https://bobibobi.tw/Fet/Lights/LightsIndex_Luer.aspx' + window.location.search;
                        break;
                }
                break;
            case "2":
