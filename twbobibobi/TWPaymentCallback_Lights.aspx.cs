...
namespace Temple
{
    public partial class TWPaymentCallback_Lights : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    DataTable dtCharge = objLightDAC.GetChargeLog_Lights(orderId);
            ...
            //                int type = objLightDAC.GetType(aid);

            //                int adminID = objLightDAC.GetAdminID(aid);


            //                objLightDAC.UpdateLightsNum2(aid, adminID, type, ref Lightslist);
            ...
            //                if (objLightDAC.UpdateChargeLog_Lights(orderId, tid, msg, Request.UserHostAddress, CallbackLog))
            //                {
            ...
            //                    string code = "";
            //                    int CodeID = objLightDAC.GetDiscountCode(adminID, aid, ref code);
            //                    if (CodeID > 0 && code != "")
            //                    {
            //                        string responseData = "";
            ...
            //                        if (objLightDAC.UpdateTime2DiscountCode(adminID, aid, CodeID, responseData))
            //                        {
            //                            m2 += "&CodeID=" + CodeID;
            //                        }
            //                    }
            ...
            //            else if (result[0] == "4")
            //            {
            //                if (objLightDAC.UpdateChargeStatus_Lights(orderId, -2))
            //                {
            ...
            //            else
            //            {
            //                objLightDAC.UpdateChargeErrLog_Lights(orderId, "", Request.UserHostAddress, CallbackLog);
